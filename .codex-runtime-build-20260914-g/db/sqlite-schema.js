...
exports.SQLITE_SCHEMA = exports.UTC_NOW_EXPR = exports.UUID_DEFAULT_EXPR = void 0;
/** SQLite expression producing a v4 UUID as lowercase text. */
exports.UUID_DEFAULT_EXPR = "lower(hex(randomblob(4)))||'-'||lower(hex(randomblob(2)))||'-4'||" +
    "substr(lower(hex(randomblob(2))),2)||'-'||" +
    "substr('89ab',abs(random())%4+1,1)||substr(lower(hex(randomblob(2))),2)||'-'||" +
    "lower(hex(randomblob(6)))";
/** SQLite expression producing the current UTC timestamp in ISO-8601. */
exports.UTC_NOW_EXPR = "strftime('%Y-%m-%dT%H:%M:%fZ','now')";
exports.SQLITE_SCHEMA = `
PRAGMA foreign_keys = ON;

CREATE TABLE IF NOT EXISTS Projects (
  id           TEXT    PRIMARY KEY COLLATE NOCASE DEFAULT (${exports.UUID_DEFAULT_EXPR}),
  slug         TEXT    NOT NULL UNIQUE COLLATE NOCASE,
  name         TEXT    NOT NULL,
  projectType  INTEGER NOT NULL,                  -- 1 = web, 2 = mobile
  status       INTEGER NOT NULL DEFAULT 0,        -- 0 = draft, 1 = ready, 2 = invalid
  enabled      INTEGER NOT NULL DEFAULT 1,
  createdAt    TEXT    NOT NULL DEFAULT (${exports.UTC_NOW_EXPR}),
  updatedAt    TEXT    NOT NULL DEFAULT (${exports.UTC_NOW_EXPR})
);

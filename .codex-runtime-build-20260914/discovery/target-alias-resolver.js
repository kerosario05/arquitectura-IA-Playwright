...
exports.resolveTargetWithAliases = resolveTargetWithAliases;
 ...
 */
function resolveTargetWithAliases(target, routeProfile) {
    ...
    const aliases = Object.entries(routeProfile.aliases).flatMap(([key, value]) => (Array.isArray(value) ? value : [value])

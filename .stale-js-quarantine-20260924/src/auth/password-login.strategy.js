...
exports.passwordLoginStrategy = void 0;
...
exports.passwordLoginStrategy = {
    name: "password",
    async execute(page, config) {
        const username = config.app.username;
        const password = config.app.password;
        if (!username || !password) {
            throw new Error("Password login mode requires APP_USERNAME and APP_PASSWORD. Use manual mode or configure credentials.");
        }
        ...
        if (!usernameInput || !passwordInput) {
            throw new Error("Could not find username/password fields. Use APP_LOGIN_MODE=manual or implement a custom login strategy in a future phase.");
        }
        ...
        if (submitInput) {
            ...
            throw new Error("Could not find login submit button. Use APP_LOGIN_MODE=manual or implement a custom login strategy in a future phase.");
        }

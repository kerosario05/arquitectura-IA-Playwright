...
(0, node_test_1.default)("T1: repairs a missing expect binding in a compatible Playwright import", () => {
    const source = "import { test } from '@playwright/test';\nawait expect(page).toBeVisible();";
    node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.repairMissingExpectImport)(source), "import { test, expect } from '@playwright/test';\nawait expect(page).toBeVisible();");
});
(0, node_test_1.default)("T2: does not change an existing expect import", () => {
    const source = "import { test, expect } from '@playwright/test';\nawait expect(page).toBeVisible();";
    node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.repairMissingExpectImport)(source), source);
});
(0, node_test_1.default)("T1 imports are rewritten independently for candidate and final spec locations", async () => {
    const finalSpecPath = node_path_1.default.resolve(process.cwd(), "automations/apps/xc/sections/detalle-kiosko/cases/C/case.spec.ts");
    const candidateSpecPath = node_path_1.default.resolve(node_path_1.default.dirname(finalSpecPath), "spec-generation/candidate.spec.ts");
    const source = [
    ...
    const candidate = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)(source, candidateSpecPath);
    const final = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)(candidate, finalSpecPath);
    node_assert_1.default.notStrictEqual(candidate, final);
    node_assert_1.default.match(final, /auth-gate-detector/);
    node_assert_1.default.match(final, /page-scanner/);
    node_assert_1.default.match(final, /from ['\"]@playwright\/test['\"]/);
    const validation = await (0, spec_generation_hybrid_1.validatePromotedSpecInternalImports)(final, finalSpecPath);
    node_assert_1.default.deepStrictEqual(validation.unresolved, []);
    node_assert_1.default.strictEqual(validation.internalImports, 3);
    node_assert_1.default.strictEqual(validation.resolved, 3);
});
(0, node_test_1.default)("T2-T5 final internal imports resolve and external imports remain unchanged", async () => {
    const finalSpecPath = node_path_1.default.resolve(process.cwd(), "automations/apps/xc/sections/detalle-kiosko/cases/C/case.spec.ts");
    const content = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)([
        "import { createPromotedSpecRuntime } from 'BROKEN';",
        "import { detectAuthGate } from '../../../../../../../../src/discovery/auth-gate-detector';",
        "import { scanCurrentPage } from '../../../../../../../../src/explorer/page-scanner';",
        "import { test } from '@playwright/test';",
    ].join("\n"), finalSpecPath);
    node_assert_1.default.match(content, /from ['\"]@playwright\/test['\"]/);
    const validation = await (0, spec_generation_hybrid_1.validatePromotedSpecInternalImports)(content, finalSpecPath);
    node_assert_1.default.strictEqual(validation.internalImports, 3);
    node_assert_1.default.strictEqual(validation.resolved, 3);
    node_assert_1.default.strictEqual(validation.unresolved.length, 0);
});
(0, node_test_1.default)("T6 unresolved final internal imports fail closed", async () => {
    const finalSpecPath = node_path_1.default.resolve(process.cwd(), "automations/apps/xc/sections/detalle-kiosko/cases/C/case.spec.ts");
    const validation = await (0, spec_generation_hybrid_1.validatePromotedSpecInternalImports)("import { missing } from '../../../../../../../src/not-real/module';", finalSpecPath);
    node_assert_1.default.strictEqual(validation.internalImports, 1);
    node_assert_1.default.strictEqual(validation.resolved, 0);
    node_assert_1.default.deepStrictEqual(validation.unresolved, ["../../../../../../../src/not-real/module"]);
});
(0, node_test_1.default)("T3: does not add expect when it is unused", () => {
    const source = "import { test } from '@playwright/test';\ntest('case', async () => {});";
    node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.repairMissingExpectImport)(source), source);
});
(0, node_test_1.default)("T4: fails closed for a local expect binding", () => {
    ...
    node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.repairMissingExpectImport)(parameterBinding), parameterBinding);
});
(0, node_test_1.default)("T7/T8: keeps the useful Playwright discovery cause after Listing tests", () => {
    node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.summarizePlaywrightDiscoveryError)("Listing tests:", "Error: Cannot find module './missing'"), "Error: Cannot find module './missing'");
    node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.summarizePlaywrightDiscoveryError)("Listing tests:", ""), "Listing tests:");
});
...
async function createTmpPaths() {
    const root = await promises_1.default.mkdtemp(node_path_1.default.join(node_os_1.default.tmpdir(), "spec-hybrid-"));
    const appDir = node_path_1.default.join(root, "automations", "apps", "test-app");
    const caseDir = node_path_1.default.join(appDir, "cases", "preview-001");
    ...
    await promises_1.default.mkdir(flowsDir, { recursive: true });
    await promises_1.default.writeFile(node_path_1.default.join(pagesDir, "home.page.ts"), "export class HomePage { constructor(_: unknown) {} async start(): Promise<void> {} }", "utf-8");
    await promises_1.default.writeFile(node_path_1.default.join(pagesDir, "login.page.ts"), "export class LoginPage { constructor(_: unknown) {} async expectLoginFormVisible(): Promise<void> {} async fillUsername(_: string): Promise<void> {} async fillPassword(_: string): Promise<void> {} async submitLogin(): Promise<void> {} }", "utf-8");
    await promises_1.default.writeFile(node_path_1.default.join(pagesDir, "operationsmenu.page.ts"), "export class OperationsMenuPage { constructor(_: unknown) {} async openModule(_: string): Promise<void> {} }", "utf-8");
    await promises_1.default.writeFile(node_path_1.default.join(flowsDir, "auth.flow.ts"), "export class AuthFlow { constructor(_: unknown) {} async ensureAuthenticated(): Promise<void> {} }", "utf-8");
    return {
        appDir,
        ...
        pagesDir,
        componentsDir: node_path_1.default.join(appDir, "components"),
        flowsDir,
        casesDir: node_path_1.default.join(appDir, "cases"),
        caseDir,
        caseConfigPath: node_path_1.default.join(caseDir, "case.json"),
        caseAutomationPath: node_path_1.default.join(caseDir, "automation.json"),
        caseEvidenceDir: node_path_1.default.join(caseDir, "evidence"),
        caseRunsDir: node_path_1.default.join(caseDir, "runs"),
        plansDir: node_path_1.default.join(appDir, "plans"),
        specsDir: node_path_1.default.join(appDir, "specs"),
        evidenceDir: node_path_1.default.join(appDir, "evidence"),
        runsDir: node_path_1.default.join(appDir, "runs"),
        planPath: node_path_1.default.join(caseDir, "plan.json"),
        specPath: node_path_1.default.join(caseDir, "case.spec.ts"),
    };
}
function buildPlan(scenarioId = "PREVIEW-001") {
    return {
        version: "1.0",
...
function buildPlanWithLogin(scenarioId = "PREVIEW-001") {
    return {
        version: "1.0",
        source: "discovery_generated",
        status: "validated",
...
function buildPlanWithAuthFlowRequired(scenarioId = "C42940") {
    return {
        version: "1.0",
        source: "discovery_generated",
        status: "validated",
...
function buildPlanWithoutAssertions(scenarioId = "PREVIEW-001") {
    return {
        version: "1.0",
        source: "discovery_generated",
        status: "validated",
...
function buildRegistry(appDir, options) {
    const pageObjects = [
        {
            id: "home",
            className: "HomePage",
            filePath: node_path_1.default.join(appDir, "pages", "home.page.ts"),
    ...
    if (options?.includeOperationsMenu) {
        pageObjects.push({
            ...
            filePath: node_path_1.default.join(appDir, "pages", "operationsmenu.page.ts"),
    ...
    if (options?.includeLoginPage) {
        pageObjects.push({
            id: "login",
            className: "LoginPage",
            filePath: node_path_1.default.join(appDir, "pages", "login.page.ts"),
...
function buildValidSpec(sectionSlug = "detalle-kiosko", scenarioId = "PREVIEW-001") {
    return [
...
function buildAuthFlowSpec(options) {
...
function buildProvider(parsedJson, usage, capture, options) {
    return {
...
function buildSequentialProvider(parsedJsons, capture) {
    let index = 0;
    return {
        providerType: "fake",
...
async function loadSkillExample(name) {
    return promises_1.default.readFile(node_path_1.default.join(process.cwd(), ".ai", "skills", "playwright-spec-generation", "examples", name), "utf-8");
}
function applyExamplePlaceholders(content, replacements) {
    return content
...
function mojibakeEncodeLevel(text) {
    let out = "";
...
function failFunctional(exitCode = 1, steps = null) {
    return Promise.resolve({
        ok: false,
        stdout: "",
...
(0, node_test_1.default)("hybrid spec generation", async (t) => {
    await t.test("valid AI spec passes all gates", async () => {
        ...
        await withEnv({
            ...
            const result = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan,
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.strictEqual(result.diagnostics.mode, "ai_hybrid");
            node_assert_1.default.strictEqual(result.diagnostics.validation.schema, "passed");
            node_assert_1.default.strictEqual(capture.request?.purpose, "spec_generation");
            node_assert_1.default.strictEqual(capture.calls, 1);
            const userPrompt = String(capture.request?.messages?.find((m) => m.role === "user")?.content ?? "");
            node_assert_1.default.ok(userPrompt.includes("\"responseJsonSchema\""));
            node_assert_1.default.ok(userPrompt.includes("\"additionalProperties\": false"));
        });
    });
    await t.test("skill content is included in prompt and request summary includes version and hash", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.ok(systemPrompt.includes("UNTRUSTED_SCENARIO_DATA"));
            node_assert_1.default.ok(userPrompt.includes("INSTRUCTIONS"));
            node_assert_1.default.ok(userPrompt.includes("name: playwright-spec-generation"));
            node_assert_1.default.ok(userPrompt.includes("OUTPUT_SCHEMA"));
            node_assert_1.default.ok(userPrompt.includes("AVAILABLE_APIS"));
            node_assert_1.default.ok(userPrompt.includes("UNTRUSTED_SCENARIO_DATA"));
            node_assert_1.default.ok(userPrompt.includes("PROMOTION_RESTRICTIONS"));
            node_assert_1.default.ok(userPrompt.indexOf("INSTRUCTIONS") < userPrompt.indexOf("AVAILABLE_RUNTIME_ALLOWLIST"));
            node_assert_1.default.ok(userPrompt.indexOf("AVAILABLE_RUNTIME_ALLOWLIST") < userPrompt.indexOf("OUTPUT_SCHEMA"));
            node_assert_1.default.ok(userPrompt.indexOf("OUTPUT_SCHEMA") < userPrompt.indexOf("AVAILABLE_APIS"));
            node_assert_1.default.ok(userPrompt.indexOf("UNTRUSTED_SCENARIO_DATA") < userPrompt.indexOf("EXECUTION_PLAN"));
            const requestSummary = JSON.parse(await promises_1.default.readFile(node_path_1.default.join(result.artifactsDir, "request-summary.json"), "utf-8"));
            node_assert_1.default.deepStrictEqual(requestSummary.skill.loaded, true);
            node_assert_1.default.strictEqual(requestSummary.skill.name, "playwright-spec-generation");
            node_assert_1.default.strictEqual(requestSummary.skill.version, "1.0.0");
            node_assert_1.default.ok(typeof requestSummary.skill.hash === "string" && requestSummary.skill.hash.length === 64);
            node_assert_1.default.strictEqual(result.diagnostics.skill.loaded, true);
        });
    });
    await t.test("same skill is sent to copilot, codex, and alternate providers without model-specific logic", async () => {
        const providers = [
            { providerName: "copilot", providerType: "copilot_cli", model: "gpt-5.4" },
            { providerName: "codex", providerType: "codex_cli", model: "gpt-5.4" },
            { providerName: "alt-provider", providerType: "fake", model: "custom-model" },
        ];
    ...
    await t.test("required missing skill blocks promotion before AI invocation and without silent fallback", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.strictEqual(result.diagnostics.invocationsConsumed, 0);
            node_assert_1.default.strictEqual(capture.calls ?? 0, 0);
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.includes("spec_generation_skill_load_failed")));
            node_assert_1.default.strictEqual(result.diagnostics.warnings.includes("ai_provider_failed_using_deterministic_fallback"), false);
        });
    });
    ...
    await t.test("flow_execution scenario rejects gate-only skill example (requires ensureAuthenticated)", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.startsWith("missing_auth_flow_ensure_authenticated")), result.diagnostics.errors.join("\n"));
            node_assert_1.default.strictEqual(result.specContent, exampleSpec);
            node_assert_1.default.ok(result.specContent.includes("new HomePage(page)"));
            node_assert_1.default.ok(result.specContent.includes("operationsMenuPage.openModule"));
            node_assert_1.default.ok(!result.specContent.includes("loginPromotedTarget("));
            node_assert_1.default.strictEqual(result.diagnostics.finalSpec.origin, "ai_candidate");
            node_assert_1.default.strictEqual(result.diagnostics.finalSpec.generatedBy, "ai");
            node_assert_1.default.strictEqual(result.diagnostics.warnings.some((warning) => warning.includes("gate_start_only_canonical_fallback_applied")), false);
            const requestSummary = JSON.parse(await promises_1.default.readFile(node_path_1.default.join(result.artifactsDir, "request-summary.json"), "utf-8"));
            const responseArtifact = JSON.parse(await promises_1.default.readFile(node_path_1.default.join(result.artifactsDir, "response.json"), "utf-8"));
            const validationArtifact = JSON.parse(await promises_1.default.readFile(node_path_1.default.join(result.artifactsDir, "validation.json"), "utf-8"));
            node_assert_1.default.strictEqual(requestSummary.finalSpec.origin, "ai_candidate");
            node_assert_1.default.strictEqual(validationArtifact.finalSpec.origin, "ai_candidate");
            node_assert_1.default.strictEqual(responseArtifact._finalSpec.origin, "ai_candidate");
        });
    });
    await t.test("flow_execution scenario never applies gate_start_only canonical fallback", async () => {
        ...
        const invalidSpec = exampleSpec.replace("assertion: async () => {", "action: async () => {");
        const response = {
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.strictEqual(result.diagnostics.validation.structure, "failed");
            node_assert_1.default.ok(!result.diagnostics.warnings.some((warning) => warning.includes("gate_start_only_canonical_fallback_applied")), result.diagnostics.warnings.join("\n"));
            node_assert_1.default.strictEqual(result.diagnostics.finalSpec.origin, "ai_candidate");
            node_assert_1.default.strictEqual(result.diagnostics.finalSpec.generatedBy, "ai");
            const requestSummary = JSON.parse(await promises_1.default.readFile(node_path_1.default.join(result.artifactsDir, "request-summary.json"), "utf-8"));
            const responseArtifact = JSON.parse(await promises_1.default.readFile(node_path_1.default.join(result.artifactsDir, "response.json"), "utf-8"));
    ...
    await t.test("gate_start_only fallback disabled blocks invalid AI candidate", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.diagnostics.finalSpec.origin, "ai_candidate");
            node_assert_1.default.strictEqual(result.diagnostics.warnings.some((warning) => warning.includes("gate_start_only_canonical_fallback_applied")), false);
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.includes("expect_promoted_visible_missing_assertion")));
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.includes("expect_promoted_visible_forbidden_action_property")));
            node_assert_1.default.strictEqual(result.diagnostics.validation.functionalExecution, "skipped");
            node_assert_1.default.strictEqual(functionalExecutions, 0);
        });
    });
    await t.test("invalid skill examples are rejected by deterministic gates", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const selectorResult = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlan(),
                deterministicDraft: buildValidSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.strictEqual(selectorResult.promotionAllowed, false);
            const runtimeResult = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlan(),
                deterministicDraft: buildValidSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.strictEqual(runtimeResult.promotionAllowed, false);
            node_assert_1.default.ok(runtimeResult.diagnostics.errors.includes("unknown_promoted_runtime_method:loginPromotedTarget"));
        });
    });
    await t.test("process.env password reference is preserved", async () => {
        const appPaths = await createTmpPaths();
        const safeRefSpec = buildValidSpec().replace("  const promotedRuntime = createPromotedSpecRuntime(page);", "  const password = process.env.APP_PASSWORD;\n  const promotedRuntime = createPromotedSpecRuntime(page);");
        const response = {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.strictEqual(result.diagnostics.errors.includes("sensitive_content_detected"), false);
            node_assert_1.default.ok(result.specContent.includes("process.env.APP_PASSWORD"));
        });
    });
    await t.test("literal password secret is blocked", async () => {
        const appPaths = await createTmpPaths();
        const secretSpec = buildValidSpec().replace("  const promotedRuntime = createPromotedSpecRuntime(page);", "  const password = \"secreto-real\";\n  const promotedRuntime = createPromotedSpecRuntime(page);");
        const response = {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.includes("sensitive_content_detected"));
        });
    });
    await t.test("validation input uses executable non-redacted content", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlan(),
                deterministicDraft: buildValidSpec(),
                appProfile: buildProfile(),
                appPaths,
                ...
                runTypeScriptValidation: async (specPath) => {
                    validationFileContent = await promises_1.default.readFile(specPath, "utf-8");
                    return passTs();
                },
                runPlaywrightDiscovery: async () => passList(1)
            });
            node_assert_1.default.ok(validationFileContent.includes("process.env.APP_PASSWORD"));
            node_assert_1.default.strictEqual(validationFileContent.includes("[REDACTED]"), false);
        });
    });
    await t.test("missing promoted runtime/finally/finishEvidence are blocked", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const missingRuntime = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
            ...
            node_assert_1.default.ok(missingRuntime.diagnostics.errors.includes("missing_createPromotedSpecRuntime"));
            const missingFinally = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlanWithAuthFlowRequired(),
                deterministicDraft: buildAuthFlowSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.ok(missingFinally.diagnostics.errors.includes("missing_finally_block"));
            const missingFinishEvidence = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlanWithAuthFlowRequired(),
                deterministicDraft: buildAuthFlowSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.ok(missingFinishEvidence.diagnostics.errors.includes("missing_finishEvidence_call"));
        });
    });
    await t.test("declared step without runtime implementation is blocked", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.includes("step_not_implemented_in_spec:2")));
        });
    });
    await t.test("wrong auth flow order and invented credentials login are blocked", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const wrongOrder = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlanWithAuthFlowRequired(),
                deterministicDraft: buildAuthFlowSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.ok(wrongOrder.diagnostics.errors.some((error) => error.includes("auth_flow_order_invalid")));
            const inventedCredentials = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlanWithAuthFlowRequired(),
                deterministicDraft: buildAuthFlowSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.ok(inventedCredentials.diagnostics.errors.includes("forbidden_credentials_login_for_auth_flow"));
        });
    });
  ...
  await expect(authFlowLabel).toBeVisible();`;
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const invalidAssertion = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlanWithAuthFlowRequired(),
                deterministicDraft: buildAuthFlowSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.ok(invalidAssertion.diagnostics.errors.some((error) => error.includes("assertion_without_observed_evidence")));
            const invalidImport = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlan(),
                deterministicDraft: buildValidSpec(),
                appProfile: buildProfile(),
                appPaths,
            ...
            node_assert_1.default.ok(invalidImport.diagnostics.errors.some((error) => error.includes("import_path_not_found:../../pages/missing.page")));
        });
    });
    await t.test("qa lab default propagates headless=true to playwright discovery and functional execution", async () => {
        const appPaths = await createTmpPaths();
        let discoveryLaunch;
        let functionalLaunch;
        await withEnv({
            AI_ENABLED: "true",
            AI_SPEC_GENERATION_ENABLED: "true",
            AI_SPEC_FUNCTIONAL_EXECUTION_ENABLED: "true",
            ...
            node_assert_1.default.strictEqual(result.diagnostics.validation.playwrightDiscovery, "passed");
            node_assert_1.default.strictEqual(result.diagnostics.validation.functionalExecution, "passed");
            node_assert_1.default.strictEqual(discoveryLaunch?.source, "qalab");
            node_assert_1.default.strictEqual(discoveryLaunch?.headless, true);
            node_assert_1.default.strictEqual(functionalLaunch?.source, "qalab");
            node_assert_1.default.strictEqual(functionalLaunch?.headless, true);
        });
    });
    await t.test("explicit headed=true propagates headless=false to functional execution", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.diagnostics.validation.functionalExecution, "passed");
            node_assert_1.default.strictEqual(functionalLaunch?.headless, false);
            node_assert_1.default.strictEqual(functionalLaunch?.source, "cli");
        });
    });
    await t.test("undeclared identifier blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("undeclared_identifier:productListPage")));
        });
    });
    await t.test("non-existing page object method blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("unknown_page_object_method:HomePage.missingMethod")));
        });
    });
    await t.test("omitted assertion blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("assertions_not_covered")));
        });
    });
    await t.test("wrong SECTION_SLUG blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("process.env.SECTION_SLUG = 'detalle-kiosko';")));
        });
    });
    await t.test("wrong SCENARIO_ID blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("process.env.SCENARIO_ID = 'PREVIEW-001';")));
        });
    });
    await t.test("UTF-8 damaged text blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.includes("utf8_damaged_text_detected"));
        });
    });
    await t.test("invalid JSON response blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.strictEqual(result.diagnostics.validation.schema, "failed");
        });
    });
    await t.test("legacy response contract with spec is rejected without deterministic fallback", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.strictEqual(result.diagnostics.validation.schema, "failed");
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("legacy_contract_not_supported")));
            node_assert_1.default.strictEqual(tsCalls, 0);
        });
    });
    await t.test("usedPageObjects as string[] is rejected", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("usedPageObjects must be object[]")));
        });
    });
    await t.test("unknown promoted runtime method loginPromotedTarget is rejected", async () => {
        const appPaths = await createTmpPaths();
        const invalidRuntimeMethodSpec = buildValidSpec().replace("await promotedRuntime.clickPromotedTarget({ stepIndex: 1, target: 'Iniciar', actionIntent: 'start_session', expectedEffect: 'ui_change', action: async () => { await homePage.start(); } });", "await promotedRuntime.loginPromotedTarget({ stepIndex: 1, target: 'auth_flow', actionIntent: 'authenticate', expectedEffect: 'ui_change', action: async () => { await homePage.start(); } });");
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const result = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlan(),
                deterministicDraft: buildValidSpec(),
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.includes("unknown_promoted_runtime_method:loginPromotedTarget"));
        });
    });
    await t.test("non-existing AuthFlow method blocks promotion", async () => {
        const appPaths = await createTmpPaths();
        const invalidAuthMethodSpec = buildAuthFlowSpec({ includeCredentialsLogin: false }).replace("await authFlow.ensureAuthenticated({ alias: 'defaultClient', landing: 'transactions_menu' });", "await authFlow.ensureOtpCompleted({ alias: 'defaultClient', landing: 'transactions_menu' });");
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const result = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlanWithAuthFlowRequired(),
                deterministicDraft: buildAuthFlowSpec(),
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.includes("unknown_auth_flow_method:ensureOtpCompleted"));
        });
    });
    await t.test("omitted login step in code blocks promotion", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("step_not_implemented_in_spec:3")));
        });
    });
    await t.test("declared assertion not present in spec code is rejected", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("assertion_implementation_not_found")));
        });
    });
    await t.test("expected result not propagated is blocked", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.includes("expected_result_not_propagated"));
        });
    });
    await t.test("validation path is created beside case.spec.ts for relative imports", async () => {
        ...
        await withEnv({ AI_SPEC_GENERATION_ENABLED: "false" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.ok(validationPath.startsWith(node_path_1.default.dirname(appPaths.specPath)));
            node_assert_1.default.ok(node_path_1.default.basename(validationPath).startsWith("case.validation-"));
        });
    });
    await t.test("provider timeout blocks promotion", async () => {
        ...
        const provider = {
            ...
            model: "model-test",
            async completeJson() {
                throw new ai_provider_types_1.AiProviderError("ai_provider_timeout", "timeout");
            }
        };
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((e) => e.includes("provider_error")));
        });
    });
    await t.test("pre-invocation provider creation error keeps invocationsConsumed=0", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_ALLOW_DETERMINISTIC_FALLBACK: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const result = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                ...
                createProvider: async () => { throw new ai_provider_types_1.AiProviderError("ai_provider_config_missing", "missing"); },
                runTypeScriptValidation: async () => passTs(),
                runPlaywrightDiscovery: async () => passList(1)
            });
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
    ...
    await t.test("typescript gate detects unknown promoted runtime method", async () => {
        ...
        await withEnv({ AI_SPEC_GENERATION_ENABLED: "false" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.strictEqual(result.diagnostics.validation.typescript, "failed");
            node_assert_1.default.ok(result.diagnostics.errors.includes("unknown_promoted_runtime_method:loginPromotedTarget"));
        });
    });
    await t.test("missing tokens remain null", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.diagnostics.usage.totalPhysicalTokens, null);
            node_assert_1.default.strictEqual(result.diagnostics.usage.credits, null);
        });
    });
        ...
        for (const id of ["PREVIEW-001", "PREVIEW-002", "PREVIEW-003", "PREVIEW-004"]) {
            await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "true", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
                const result = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                    ...
                    sectionSlug: "detalle-kiosko",
                    pageObjectRegistry: buildRegistry(appPaths.appDir),
                    provider: buildProvider({ specs: batchSpecs })
                }, { runTypeScriptValidation: async () => passTs(), runPlaywrightDiscovery: async () => passList(1) });
                node_assert_1.default.strictEqual(result.promotionAllowed, true);
            });
        }
    ...
    await t.test("invalid scenario in batch is rejected independently", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "true", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            const valid = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                ...
                sectionSlug: "detalle-kiosko",
                pageObjectRegistry: buildRegistry(appPaths.appDir),
                provider: buildProvider({ specs })
            }, { runTypeScriptValidation: async () => passTs(), runPlaywrightDiscovery: async () => passList(1) });
            node_assert_1.default.strictEqual(valid.promotionAllowed, true);
            const invalid = await (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
            ...
            node_assert_1.default.strictEqual(invalid.promotionAllowed, false);
        });
    });
    await t.test("deterministic mode works when AI spec generation is disabled", async () => {
        ...
        await withEnv({ AI_SPEC_GENERATION_ENABLED: "false" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.strictEqual(result.diagnostics.mode, "deterministic");
            node_assert_1.default.strictEqual(result.diagnostics.invocations, 0);
        });
    });
    await t.test("first pass request includes observable oracles and promotes without repair", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.ok(requestContent.includes("OBSERVABLE_ORACLES"));
            node_assert_1.default.ok(requestContent.includes("navigation_transition"));
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.strictEqual(result.diagnostics.specGenerationAttempts, 1);
            node_assert_1.default.strictEqual(result.diagnostics.specRepairAttempts, 0);
            node_assert_1.default.strictEqual(result.diagnostics.firstPassPromotion, true);
        });
    });
    ...
    await t.test("playwright discovery must find exactly one test", async () => {
        ...
        await withEnv({ AI_SPEC_GENERATION_ENABLED: "false" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.strictEqual(result.diagnostics.validation.playwrightDiscovery, "failed");
        });
    });
    await t.test("playwright list is not sufficient when functional execution fails", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_FUNCTIONAL_EXECUTION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.diagnostics.validation.playwrightDiscovery, "passed");
            node_assert_1.default.strictEqual(result.diagnostics.validation.functionalExecution, "failed");
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.includes("functional_execution_failed")));
        });
    });
    await t.test("functional execution with evidence steps zero is rejected", async () => {
        ...
        await withEnv({ AI_ENABLED: "true", AI_SPEC_GENERATION_ENABLED: "true", AI_SPEC_FUNCTIONAL_EXECUTION_ENABLED: "true", AI_SPEC_BATCH_PER_ISSUE: "false", AI_SPEC_PROVIDER: "copilot_cli", AI_SPEC_MODEL: "m" }, async () => {
            ...
            node_assert_1.default.strictEqual(result.diagnostics.validation.functionalExecution, "failed");
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.includes("functional_execution_no_evidence_steps")));
        });
    });
    await t.test("repairable gate failure triggers one bounded AI repair attempt and can promote the repaired candidate", async () => {
        const appPaths = await createTmpPaths();
        const capture = { requests: [], calls: 0 };
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.strictEqual(result.diagnostics.invocationsConsumed, 2);
            node_assert_1.default.strictEqual(result.diagnostics.specGenerationAttempts, 2);
            node_assert_1.default.strictEqual(result.diagnostics.specRepairAttempts, 1);
            node_assert_1.default.strictEqual(result.diagnostics.firstPassPromotion, false);
            node_assert_1.default.strictEqual(result.diagnostics.finalSpec.origin, "ai_candidate");
            node_assert_1.default.strictEqual(result.diagnostics.finalSpec.fallback, null);
            node_assert_1.default.ok(result.diagnostics.warnings.some((warning) => warning.includes("ai_repair_attempt_applied:1")));
            node_assert_1.default.strictEqual(capture.calls, 2);
            node_assert_1.default.ok(String(capture.requests[1]?.messages[1]?.content ?? "").includes("Fix exactly these failed gates"));
            node_assert_1.default.ok(String(capture.requests[1]?.messages[1]?.content ?? "").includes("REPAIR_CONTEXT"));
            node_assert_1.default.ok(String(capture.requests[1]?.messages[1]?.content ?? "").includes("EXECUTION_PLAN_FOCUS"));
        });
    });
    ...
    await t.test("repair context includes exact semantic coverage oracle error details", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.ok(repairPayload.includes("missing_assertion_oracle_context:"));
            node_assert_1.default.ok(repairPayload.includes("resolvedTarget=Explora nuestros productos"));
        });
    });
    await t.test("repair context includes exact playwright discovery stderr summary", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            const repairPayload = String(capture.requests[1]?.messages[1]?.content ?? "");
            node_assert_1.default.ok(repairPayload.includes("playwright_discovery_error:Error: No tests found for candidate spec"));
        });
    });
    await t.test("repair attempt re-runs all validation gates before promotion", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.strictEqual(capture.calls, 2);
            node_assert_1.default.strictEqual(tsRuns, 2);
            node_assert_1.default.strictEqual(listRuns, 2);
            node_assert_1.default.strictEqual(functionalRuns, 2);
        });
    });
    await t.test("structural failure triggers one repair attempt and captures failed gates from attempt 1", async () => {
        ...
        await withEnv({
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, true);
            node_assert_1.default.strictEqual(capture.calls, 2);
            node_assert_1.default.ok(result.diagnostics.failedGatesAttempt1.includes("structuralValidation"));
        });
    });
    await t.test("B1 unresolved requirement error is surfaced in semantic repair payload with missing requirements and passed gates", async () => {
        ...
        const { logs, result } = await withCapturedLogs(() => withEnv(env, async () => {
            return (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
                plan: buildPlan(),
                deterministicDraft: buildValidSpec(),
                appProfile: buildProfile(),
                appPaths,
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true);
        node_assert_1.default.strictEqual(capture.calls, 2);
        node_assert_1.default.ok(result.diagnostics.missingRequirements.some((m) => m.text === "Boton iniciar visible"));
        node_assert_1.default.ok(result.diagnostics.missingRequirements.some((m) => m.type === "literal_visible_text"));
        node_assert_1.default.ok(logs.some((line) => line.startsWith("[semantic-coverage] missing=") && line.includes("Boton iniciar visible")));
        const repairPayload = String(capture.requests[1]?.messages[1]?.content ?? "");
        node_assert_1.default.ok(repairPayload.includes("unresolved_requirement:Boton iniciar visible"));
        node_assert_1.default.ok(repairPayload.includes("\"missingRequirements\""));
        node_assert_1.default.ok(repairPayload.includes("\"passedGatesAttempt1\""));
        node_assert_1.default.ok(repairPayload.includes("structuralValidation"));
    });
    await t.test("B2 missing requirement type follows the linked observable oracle", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true);
        node_assert_1.default.ok(result.diagnostics.missingRequirements.some((m) => m.text === "Boton iniciar visible" && m.type === "heading_or_control"));
    });
    await t.test("B3 literal_visible_text type is inferred with stepIndex from scenario step", async () => {
        ...
        node_assert_1.default.ok(missing);
        node_assert_1.default.strictEqual(missing.type, "literal_visible_text");
        node_assert_1.default.strictEqual(missing.stepIndex, 2);
    });
    await t.test("B4 no missing requirements are reported when semantic coverage passes", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true);
        node_assert_1.default.strictEqual(result.diagnostics.missingRequirements.length, 0);
    });
    await t.test("C1 functional execution failure surfaces the exact error line in the repair payload", async () => {
        ...
        node_assert_1.default.strictEqual(capture.calls, 2);
        const repairPayload = String(capture.requests[1]?.messages[1]?.content ?? "");
        node_assert_1.default.ok(repairPayload.includes("functional_execution_failed:exitCode=1"));
        node_assert_1.default.ok(repairPayload.includes("functional_execution_error:Error: expect(received).toHaveText()"));
        node_assert_1.default.ok(logs.some((line) => line.startsWith("[functional-execution] exitCode=1 error=\"Error: expect(received).toHaveText()\" file=\"case.spec.ts:12:1\" line=\"test failed\" timeout=false")));
    });
    await t.test("C2 functional timeout failure is logged with timeout=true and the located error", async () => {
        ...
        node_assert_1.default.ok(logLine);
        node_assert_1.default.ok(logLine.includes("exitCode=1"));
        node_assert_1.default.ok(logLine.includes("timeout=true"));
        node_assert_1.default.ok(logLine.includes("locator resolved to 0 elements"));
    });
    await t.test("C3 functional execution ok with zero evidence steps is rejected with no_evidence_steps error", async () => {
        ...
        node_assert_1.default.strictEqual(capture.calls, 2);
        const repairPayload = String(capture.requests[1]?.messages[1]?.content ?? "");
        node_assert_1.default.ok(repairPayload.includes("functional_execution_no_evidence_steps:steps=0"));
    });
    await t.test("D1 repair that regresses a previously passed gate is rejected with regressedGates", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, false);
        node_assert_1.default.ok(result.diagnostics.regressedGates.includes("structuralValidation"));
        node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.startsWith("repair_rejected:regressed_gates:")));
        node_assert_1.default.ok(result.diagnostics.warnings.includes("repair_rejected_regressed_gates"));
        node_assert_1.default.ok(logs.some((line) => line.startsWith("[spec-repair] regressedGates=") && line.includes("structuralValidation")));
    });
    await t.test("D2 repair preserving previously passed gates promotes with no regressions", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true);
        node_assert_1.default.strictEqual(result.diagnostics.regressedGates.length, 0);
    });
    await t.test("D3 repair regression is detected across all gates including typescript", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, false);
        node_assert_1.default.ok(result.diagnostics.regressedGates.includes("typescriptValidation"));
        node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.startsWith("repair_rejected:regressed_gates:")));
    });
    ...
    await t.test("A1 phantom login step without auth signals does not force auth", async () => {
        const appPaths = await createTmpPaths();
        const { logs } = await withCapturedLogs(() => withEnv({ AI_SPEC_GENERATION_ENABLED: "false" }, async () => (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
        ...
        node_assert_1.default.ok(joined.includes("[spec-auth-contract] mode=none"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-contract] mode=flow_execution"), joined);
        node_assert_1.default.ok(joined.includes("[spec-contract] contractValid=true"), joined);
    });
    ...
    await t.test("A4 backed auth_gate oracle with login step drives flow_execution", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("[spec-auth-contract] mode=flow_execution"), joined);
        node_assert_1.default.ok(joined.includes("backedAuthGateOracle=true"), joined);
    });
    await t.test("B5 observed catalog/knowledge text is not an authorized requirement source", async () => {
        const appPaths = await createTmpPaths();
        const { logs, result } = await withCapturedLogs(() => withEnv({ AI_SPEC_GENERATION_ENABLED: "false" }, async () => (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
            plan: buildPlan(),
            deterministicDraft: buildValidSpec(),
            appProfile: buildProfile(),
            appPaths,
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("[spec-requirement-filter] reason=untraceable_requirement_source"), joined);
        node_assert_1.default.ok(!logs.some((log) => log.startsWith("[spec-requirement] ") && log.includes("Descripción general del depósito a plazo")), joined);
        node_assert_1.default.strictEqual(result.promotionAllowed, true);
    });
    await t.test("B6 scenario step expected is an authorized requirement", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("id=scenario-step-2 source=scenario_step"), joined);
        node_assert_1.default.ok(!joined.includes("id=plan-step-2 source=validated_plan"), joined);
        node_assert_1.default.ok(joined.includes("[spec-contract] contractValid=true"), joined);
    });
    ...
    await t.test("B8 traceable observable oracle is an authorized requirement", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("id=oracle-01 source=observable_oracle"), joined);
        node_assert_1.default.ok(joined.includes("oracleType=navigation_transition backed=true required=true"), joined);
        node_assert_1.default.ok(joined.includes("[spec-contract] contractValid=true"), joined);
    });
    await t.test("B9 unsupported unresolved oracle is still an authorized requirement that must block", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("id=expected-01 source=observable_oracle"), joined);
        node_assert_1.default.ok(joined.includes("oracleType=unsupported_or_unresolved backed=false required=true"), joined);
        node_assert_1.default.ok(joined.includes("[spec-contract] contractValid=false"), joined);
    });
    await t.test("C10 required unresolved oracle blocks promotion with zero attempts and no AI call", async () => {
        ...
        const result = await withEnv({
            ...
            AI_SPEC_PROVIDER: "copilot_cli",
            AI_SPEC_MODEL: "m"
        }, async () => (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
            plan: buildPlan(),
            deterministicDraft: buildValidSpec(),
            appProfile: buildProfile(),
            appPaths,
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, false);
        node_assert_1.default.strictEqual(result.diagnostics.specGenerationAttempts, 0);
        node_assert_1.default.strictEqual(result.diagnostics.specRepairAttempts, 0);
        node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.startsWith("promotion_oracle_gate:unresolved_required_requirement:Tasas y beneficios mostrados")), result.diagnostics.errors.join("\n"));
        node_assert_1.default.ok(result.diagnostics.warnings.some((warning) => warning.includes("promotion_oracle_gate:contract_invalid")), result.diagnostics.warnings.join("\n"));
        node_assert_1.default.strictEqual(capture.calls, undefined);
    });
    await t.test("C11 contextual inferred oracle does not block promotion", async () => {
        const appPaths = await createTmpPaths();
        const result = await withEnv({ AI_SPEC_GENERATION_ENABLED: "false" }, async () => (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
            plan: buildPlan(),
            deterministicDraft: buildValidSpec(),
            appProfile: buildProfile(),
            appPaths,
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true);
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("promotion_oracle_gate:")), result.diagnostics.errors.join("\n"));
    });
    await t.test("C12 expected result with no enforceable assertions emits gate errors", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, false);
        node_assert_1.default.strictEqual(result.diagnostics.specGenerationAttempts, 0);
        node_assert_1.default.ok(result.diagnostics.errors.includes("expected_result_not_propagated"), result.diagnostics.errors.join("\n"));
        node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.startsWith("promotion_oracle_gate:unresolved_required_requirement:Resultado esperado no evidenciado")), result.diagnostics.errors.join("\n"));
        node_assert_1.default.strictEqual(result.diagnostics.missingRequirements.length, 1);
    });
    await t.test("D13 auth narrative expected result is covered by gate observation", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("[spec-auth-contract] mode=gate_observation"), joined);
        node_assert_1.default.ok(joined.includes("reason=auth_flow_covers_expected_result"), joined);
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("promotion_oracle_gate:")), result.diagnostics.errors.join("\n"));
    });
    ...
    await t.test("E16 AI coverage of unauthorized catalog/knowledge requirement is extraneous", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, false);
        node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.includes("extraneous_requirement:Catálogo de productos y tasas")), result.diagnostics.errors.join("\n"));
    });
    ...
    await t.test("E18 auth-flow-covered assertion is not extraneous", async () => {
        ...
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.includes("extraneous_requirement:flujo de autenticación")), result.diagnostics.errors.join("\n"));
    });
    ...
    await t.test("F21 contract-invalid input is never sent to AI repair", async () => {
        ...
        node_assert_1.default.strictEqual(result.diagnostics.specGenerationAttempts, 0);
        node_assert_1.default.strictEqual(result.diagnostics.specRepairAttempts, 0);
        node_assert_1.default.strictEqual(capture.calls, 0);
    });
    await t.test("G22 mojibake-equivalent oracle requirement matches normalized semantic coverage", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true, result.diagnostics.errors.join("\n"));
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("missing_assertion_coverage:")), result.diagnostics.errors.join("\n"));
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("extraneous_requirement:")), result.diagnostics.errors.join("\n"));
    });
    await t.test("G23 reconciled auth_gate observation drives gate_observation, not flow_execution or literal", async () => {
        ...
        node_assert_1.default.ok(!joined.includes("[spec-auth-contract] mode=flow_execution"), joined);
        node_assert_1.default.ok(joined.includes("backedAuthGateOracle=true"), joined);
        node_assert_1.default.ok(!logs.some((log) => log.startsWith("[spec-requirement] ") && log.includes("type=literal_visible_text") && log.includes("flujo de autenticación")), joined);
    });
    await t.test("H1 scenario without auth resolves to none contract", async () => {
        ...
        node_assert_1.default.ok(joined.includes("[spec-auth-contract] mode=none"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-contract] mode=flow_execution"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-outcome] mode=flow_execution"), joined);
    });
    ...
    await t.test("H3 backed auth_gate with gate objective resolves to gate_observation", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("[spec-auth-contract] mode=gate_observation"), joined);
        node_assert_1.default.ok(joined.includes("[spec-auth-outcome] mode=gate_observation source=backed_auth_gate reason=scenario_requires_auth_gate_observation"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-outcome] mode=flow_execution"), joined);
    });
    await t.test("H4 expectedResult with 'autenticada' never elevates gate_observation to flow_execution", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("[spec-auth-contract] mode=gate_observation"), joined);
        node_assert_1.default.ok(joined.includes("[spec-auth-outcome] mode=gate_observation source=backed_auth_gate"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-outcome] mode=flow_execution"), joined);
    });
    await t.test("H5 APP_LOGIN_MODE=password does not change gate_observation to flow_execution", async () => {
        const appPaths = await createTmpPaths();
        const { logs } = await withCapturedLogs(() => withEnv({ AI_SPEC_GENERATION_ENABLED: "false", APP_LOGIN_MODE: "password", APP_USERNAME: "u", APP_PASSWORD: "p" }, async () => (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
            plan: buildPlanWithoutAssertions(),
            deterministicDraft: buildValidSpec(),
            appProfile: buildProfile(),
            appPaths,
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("[spec-auth-outcome] mode=gate_observation"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-outcome] mode=flow_execution"), joined);
    });
    ...
    await t.test("H7 explicit login step with validated auth completion resolves to flow_execution", async () => {
        ...
        const joined = logs.join("\n");
        node_assert_1.default.ok(joined.includes("[spec-auth-contract] mode=flow_execution"), joined);
        node_assert_1.default.ok(joined.includes("[spec-auth-outcome] mode=flow_execution source=validated_auth_completion reason=explicit_validated_auth_completion_authority stepIndex=3"), joined);
    });
    ...
    await t.test("H9 global login config alone never resolves to flow_execution", async () => {
        const appPaths = await createTmpPaths();
        const { logs } = await withCapturedLogs(() => withEnv({ AI_SPEC_GENERATION_ENABLED: "false", APP_LOGIN_MODE: "password", APP_USERNAME: "u", APP_PASSWORD: "p", Identity_Provider: "1", OTP_SECRET: "s" }, async () => (0, spec_generation_hybrid_1.runHybridSpecGeneration)({
            plan: buildPlanWithoutAssertions(),
            deterministicDraft: buildValidSpec(),
            appProfile: buildProfile(),
            appPaths,
    ...
    await t.test("H10 gate_observation semantic coverage never requires ensureAuthenticated", async () => {
        ...
        node_assert_1.default.ok(!result.diagnostics.errors.includes("missing_auth_flow_ensure_authenticated"), result.diagnostics.errors.join("\n"));
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("missing_auth_flow_ensure_authenticated")), result.diagnostics.errors.join("\n"));
    });
    ...
    await t.test("H12 gate_observation never flips to flow_execution without explicit authority", async () => {
        ...
        node_assert_1.default.ok(joined.includes("[spec-auth-outcome] mode=gate_observation"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-outcome] mode=flow_execution"), joined);
        node_assert_1.default.ok(!joined.includes("[spec-auth-invariant]"), joined);
    });
    await t.test("M1 already-correct text is preserved", () => {
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("autenticación"), "autenticación");
    });
    await t.test("M2 single-level UTF-8 mojibake decodes", () => {
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("autenticaciÃ³n"), "autenticación");
    });
    await t.test("M3 double-level UTF-8 mojibake decodes", () => {
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("autenticaciÃƒÂ³n"), "autenticación");
    });
    await t.test("M4 multiple corrupted characters normalize together", () => {
        ...
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)(corrupted), source);
    });
    await t.test("M5 legit Unicode beyond latin-1 is preserved", () => {
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("日本語"), "日本語");
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("€"), "€");
    });
    await t.test("M6 common legit Spanish text is preserved", () => {
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("¿Qué deseas realizar hoy?"), "¿Qué deseas realizar hoy?");
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("Cédula de identidad dominicana"), "Cédula de identidad dominicana");
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("Información"), "Información");
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("señal"), "señal");
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("José"), "José");
    });
    ...
    await t.test("M9 functionally different candidate assertion does not match", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, false);
        node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.startsWith("missing_assertion_coverage:flujo de autenticación")), result.diagnostics.errors.join("\n"));
    });
    ...
    await t.test("M11 max iterations are bounded (no unbounded decode)", () => {
        let fourLevels = "ó";
        for (let i = 0; i < 4; i += 1)
            fourLevels = mojibakeEncodeLevel(fourLevels);
        node_assert_1.default.notStrictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)(fourLevels), "ó");
        let threeLevels = "ó";
        for (let i = 0; i < 3; i += 1)
            threeLevels = mojibakeEncodeLevel(threeLevels);
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)(threeLevels), "ó");
    });
    await t.test("M12 stable text terminates immediately (no infinite loop)", () => {
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("Hello World"), "Hello World");
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("autenticación"), "autenticación");
        node_assert_1.default.strictEqual((0, spec_generation_hybrid_1.normalizeMojibakeUtf8)("日本語"), "日本語");
    });
    function buildSpecWithExpectTarget(target) {
    ...
    await t.test("A1 technical auth metadata present is never converted into a UI target", async () => {
        ...
        const requestContent = String(capture.request?.messages[1]?.content ?? "");
        node_assert_1.default.strictEqual(result.promotionAllowed, true, result.diagnostics.errors.join("\n"));
        node_assert_1.default.ok(requestContent.includes("ORACLE_IMPLEMENTATIONS"));
        node_assert_1.default.ok(requestContent.includes('"oracleType": "auth_gate"'));
        node_assert_1.default.ok(requestContent.includes('"implementationKind": "runtime_auth_state"'));
        const phrasesMatch = requestContent.match(/"observedEvidencePhrases":\s*\[([^\]]*)\]/);
        const phrasesJson = phrasesMatch?.[1] ?? "";
        node_assert_1.default.ok(!phrasesJson.includes("auth_gate_detected:true"), "technical metadata leaked into observed evidence phrases");
        node_assert_1.default.ok(!phrasesJson.includes("auth_stage:unknown"), "technical metadata leaked into observed evidence phrases");
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("technical_metadata_used_as_runtime_target:")), result.diagnostics.errors.join("\n"));
    });
    for (const technicalTarget of ["auth_gate_detected:true", "auth_stage:foo", "gateType:customer_identification_otp", "backed:true", "confidence:0.95", "auth_gate"]) {
        await t.test(`A2-A6 runtime target gate rejects technical metadata target '${technicalTarget}'`, async () => {
            ...
            node_assert_1.default.strictEqual(result.promotionAllowed, false);
            node_assert_1.default.strictEqual(result.diagnostics.validation.structure, "failed");
            node_assert_1.default.strictEqual(functionalExecutions, 0, "functional execution must be short-circuited before the technical target gate");
            node_assert_1.default.ok(result.diagnostics.errors.some((error) => error.startsWith(`technical_metadata_used_as_runtime_target:stepIndex=2:target="${technicalTarget}"`)), result.diagnostics.errors.join("\n"));
        });
    }
    await t.test("A7 real heading/control target passes the runtime target gate", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true, result.diagnostics.errors.join("\n"));
        node_assert_1.default.strictEqual(result.diagnostics.validation.structure, "passed");
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("technical_metadata_used_as_runtime_target:")), result.diagnostics.errors.join("\n"));
    });
    await t.test("A8 ORACLE_IMPLEMENTATIONS provides a runtime_auth_state descriptor for backed auth_gate without stage/url", async () => {
        ...
        await withEnv({
            ...
            const requestContent = String(capture.request?.messages[1]?.content ?? "");
            node_assert_1.default.ok(requestContent.includes("ORACLE_IMPLEMENTATIONS"));
            node_assert_1.default.ok(requestContent.includes('"implementationKind": "runtime_auth_state"'), requestContent);
        });
    });
    await t.test("A9 auth_gate with details.stage maps to an auth_stage descriptor with expectedStage", async () => {
        ...
        await withEnv({
            ...
            const requestContent = String(capture.request?.messages[1]?.content ?? "");
            node_assert_1.default.ok(requestContent.includes('"implementationKind": "auth_stage"'), requestContent);
            node_assert_1.default.ok(requestContent.includes('"expectedStage": "otp_verification"'), requestContent);
        });
    });
    await t.test("A10 auth_gate with details.expectedUrl maps to a url_state descriptor with expectedUrlPattern", async () => {
        ...
        await withEnv({
            ...
            const requestContent = String(capture.request?.messages[1]?.content ?? "");
            node_assert_1.default.ok(requestContent.includes('"implementationKind": "url_state"'), requestContent);
            node_assert_1.default.ok(requestContent.includes('"expectedUrlPattern": "/login"'), requestContent);
        });
    });
    await t.test("A11 repair receives the failed technical target and a fixed candidate promotes", async () => {
        ...
        node_assert_1.default.ok(repairRequestContent.includes('"failedTarget": "auth_gate_detected:true"'), repairRequestContent);
        node_assert_1.default.ok(repairRequestContent.includes("technical_metadata_used_as_runtime_target"), repairRequestContent);
        node_assert_1.default.ok(repairRequestContent.includes("Do not use technical evidence metadata"), repairRequestContent);
    });
    await t.test("A12 gate_start_only canonical fallback is exempted from the technical target gate", async () => {
        ...
        node_assert_1.default.strictEqual(result.promotionAllowed, true, result.diagnostics.errors.join("\n"));
        node_assert_1.default.strictEqual(result.diagnostics.finalSpec.origin, "gate_start_only_canonical_fallback");
        node_assert_1.default.strictEqual(result.diagnostics.finalSpec.generatedBy, "core");
        node_assert_1.default.ok(result.diagnostics.warnings.some((warning) => warning.includes("gate_start_only_canonical_fallback_applied")), result.diagnostics.warnings.join("\n"));
        node_assert_1.default.ok(!result.diagnostics.errors.some((error) => error.startsWith("technical_metadata_used_as_runtime_target:")), result.diagnostics.errors.join("\n"));
    });
    await t.test("runtime import is resolved from the actual spec file location", () => {
        const specPath = node_path_1.default.resolve(process.cwd(), "automations", "apps", "A", "sections", "S", "cases", "C", "spec-generation", "candidate.spec.ts");
        const content = "import { createPromotedSpecRuntime } from '../../../../../../../src/automations/runtime/promoted-spec-runtime';";
        const rewritten = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)(content, specPath);
        node_assert_1.default.ok(rewritten.includes("/src/automations/runtime/promoted-spec-runtime"));
        node_assert_1.default.ok(!rewritten.includes("\\"));
    });
    await t.test("runtime import stays valid for different nesting depths", () => {
        const specPath = node_path_1.default.resolve(process.cwd(), "some", "deep", "nested", "candidate.spec.ts");
        const content = "import { createPromotedSpecRuntime } from '../../../../../../../src/automations/runtime/promoted-spec-runtime';";
        const rewritten = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)(content, specPath);
        node_assert_1.default.ok(rewritten.includes("createPromotedSpecRuntime"));
        node_assert_1.default.ok(rewritten.includes("/src/automations/runtime/promoted-spec-runtime"));
    });
    ...
    await t.test("candidate spec path resolves the runtime module on disk", async () => {
        const candidatePath = node_path_1.default.resolve(process.cwd(), "automations", "apps", "A", "sections", "S", "cases", "C", "spec-generation", "candidate.spec.ts");
        const content = "import { createPromotedSpecRuntime } from 'BROKEN';";
        const rewritten = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)(content, candidatePath);
        const importPath = rewritten.match(/from '([^']+)'/)?.[1];
        node_assert_1.default.ok(importPath);
        node_assert_1.default.equal((await promises_1.default.stat(node_path_1.default.resolve(node_path_1.default.dirname(candidatePath), `${importPath}.ts`))).isFile(), true);
    });
    await t.test("candidate written to spec-generation contains the corrected import", async () => {
        const tempRoot = await promises_1.default.mkdtemp(node_path_1.default.join(node_os_1.default.tmpdir(), "promoted-runtime-candidate-"));
        const candidatePath = node_path_1.default.join(tempRoot, "spec-generation", "candidate.spec.ts");
        await promises_1.default.mkdir(node_path_1.default.dirname(candidatePath), { recursive: true });
        const rewritten = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)("import { createPromotedSpecRuntime } from 'BROKEN';", candidatePath);
        await promises_1.default.writeFile(candidatePath, rewritten, "utf-8");
        const persisted = await promises_1.default.readFile(candidatePath, "utf-8");
        node_assert_1.default.equal(persisted, rewritten);
        await promises_1.default.rm(tempRoot, { recursive: true, force: true });
    });
    await t.test("already promoted spec content remains intact", () => {
        const specPath = node_path_1.default.resolve(process.cwd(), "automations", "apps", "A", "sections", "S", "cases", "C", "case.spec.ts");
        const content = "import { createPromotedSpecRuntime } from '../../../../../../../src/automations/runtime/promoted-spec-runtime';\nconst x = 1;";
        const rewritten = (0, spec_generation_hybrid_1.rewritePromotedRuntimeImport)(content, specPath);
        node_assert_1.default.ok(rewritten.includes("const x = 1;"));
        node_assert_1.default.ok(rewritten.includes("createPromotedSpecRuntime"));
    });
});

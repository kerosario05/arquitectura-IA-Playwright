...
function isConfiguredJsonLike(rawValue) {
    if (!rawValue) {
        return false;
    }
...
function runInspection() {
    ...
    console.log("");
    console.log(`Dynamic aliases groups: ${Object.keys(env_1.config.app.testDataAliases).length}`);
    console.log(`Missing input behavior: ${env_1.config.app.missingInputBehavior}`);
    console.log("");

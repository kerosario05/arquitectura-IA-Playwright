...
require("../config/env");
const knowledge_health_1 = require("../knowledge/knowledge-health");
...
async function main() {
    ...
    const knowledge = (0, mobile_knowledge_resolver_1.loadMobileKnowledge)(appSlug);
    const report = (0, knowledge_health_1.analyzeKnowledgeHealth)(knowledge.items);
    ...
    if (forText) {
        const screens = (0, mobile_knowledge_resolver_1.selectRelevantMobileKnowledge)(knowledge, forText, 5);
        ...
        for (const s of screens) {
            ...
            if (s.disabledTargets.length > 0)
                console.log(`      bloqueados: ${s.disabledTargets.join(", ")}`);
        }
    }

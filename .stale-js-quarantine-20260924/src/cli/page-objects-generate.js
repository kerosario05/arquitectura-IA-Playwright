...
const page_object_codegen_1 = require("../automations/page-object-codegen");
...
async function main() {
    ...
    if (args.only)
        console.log(`[page-objects:generate] Only: ${args.only}`);
    ...
    const result = await (0, page_object_codegen_1.generatePageObjectCandidateFiles)(options);
    console.log("");

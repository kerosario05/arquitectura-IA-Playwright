...
exports.resolveCompoundFormFieldsAssertion = resolveCompoundFormFieldsAssertion;
exports.parseCompoundFormFieldsAssertion = parseCompoundFormFieldsAssertion;
exports.extractQuotedFields = extractQuotedFields;
...
function extractQuotedFields(text) {
    const fields = [];
...
function detectContainerKind(text) {
...
function parseCompoundFormFieldsAssertion(assertionText) {
...
function isFieldVisibleInSnapshot(snapshot, fieldName) {
...
function resolveCompoundFormFieldsAssertion(snapshot, assertionText) {

...
exports.resolveFeedbackMessageAssertion = resolveFeedbackMessageAssertion;
exports.isFeedbackAssertion = isFeedbackAssertion;
exports.findFeedbackMessages = findFeedbackMessages;
...
function isFeedbackAssertion(assertionText) {
...
function detectFeedbackMessageType(element) {
    ...
    for (const pattern of FEEDBACK_CLASS_PATTERNS) {
        if (pattern.test(normalizedClass)) {
            if (normalizedClass.includes("toast"))
                return "toast";
            if (normalizedClass.includes("snackbar"))
                return "snackbar";
            if (normalizedClass.includes("alert"))
                return "alert";
            if (normalizedClass.includes("notification"))
                return "notification";
            if (normalizedClass.includes("banner"))
                return "banner";
            if (normalizedClass.includes("modal") || normalizedClass.includes("dialog"))
                return "modal";
            return "status_message";
        }
    }
...
function findFeedbackMessages(snapshot) {
    const messages = [];
...
function resolveFeedbackMessageAssertion(snapshot, assertionText) {

...
exports.resolvePreSubmitBlockers = resolvePreSubmitBlockers;
exports.isSubmitLikeAction = isSubmitLikeAction;
exports.isSensitiveConsent = isSensitiveConsent;
exports.detectBlockers = detectBlockers;
...
async function detectBlockers(snapshot, submitLocator) {
    ...
    for (const element of snapshot.elements) {
        ...
        const ariaRequired = element.ariaRequired;
        const required = element.required;
        const ariaInvalid = element.ariaInvalid;
...
async function resolvePreSubmitBlockers(options) {

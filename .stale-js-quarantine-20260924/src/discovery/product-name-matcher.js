...
exports.findBestProductNameMatch = findBestProductNameMatch;
 ...
 */
function matchProductName(expected, actual, options) {
 ...
 */
function findBestProductNameMatch(expected, elements, options) {
    const minScore = options?.minSemanticScore ?? 0.7;
    ...
    for (const el of elements) {
        ...
        const isHeading = preferHeadings && (el.role === "heading" || el.tagName === "h1" || el.tagName === "h2" || el.tagName === "h3");

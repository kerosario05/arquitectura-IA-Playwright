...
exports.isSelectionLikeTarget = isSelectionLikeTarget;
exports.extractMeaningfulTokens = extractMeaningfulTokens;
exports.verifyPostClickSemanticMatch = verifyPostClickSemanticMatch;
exports.getSelectionConfidenceThreshold = getSelectionConfidenceThreshold;
exports.getSelectionAiRepairThreshold = getSelectionAiRepairThreshold;
exports.isSelectionConfidenceSufficient = isSelectionConfidenceSufficient;
exports.shouldInvokeAiSelectionResolution = shouldInvokeAiSelectionResolution;
exports.shouldBlockSemanticFallback = shouldBlockSemanticFallback;
exports.buildSelectionCandidatesFromSnapshot = buildSelectionCandidatesFromSnapshot;
/**
 ...
 */
function isSelectionLikeTarget(target) {
 ...
 */
function extractMeaningfulTokens(target) {
    const normalized = target.toLowerCase();
 ...
 */
function verifyPostClickSemanticMatch(target, visibleTexts, pageTitle, effectiveTarget) {
 ...
 */
function getSelectionAiRepairThreshold() {
 ...
 */
function isSelectionConfidenceSufficient(confidence) {
    return confidence >= getSelectionConfidenceThreshold();
}
/**
 * Check if AI selection_resolution should be invoked
 */
function shouldInvokeAiSelectionResolution(confidence, isAmbiguous) {
 ...
 */
function shouldBlockSemanticFallback(target, confidence, strategy) {
 ...
 */
function isProductCardElement(el) {
 ...
 */
function buildSelectionCandidatesFromSnapshot(snapshot, target, existingCandidates) {
    const candidates = [];
    ...
    for (let i = 0; i < productElements.length; i++) {
        ...
        const elementTexts = [el.text, el.name, el.label, el.placeholder, el.nearbyText].filter((t) => Boolean(t));

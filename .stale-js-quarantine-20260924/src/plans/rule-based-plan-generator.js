...
exports.generateRuleBasedExecutionPlan = generateRuleBasedExecutionPlan;
...
function generateRuleBasedExecutionPlan(scenario, options) {
    const steps = [];
    let stepIndex = 1;
    ...
    for (const sourceStep of scenario.steps) {
        steps.push({
            ...
            ...(sourceStep.conditionalAction ? {
                ...
                target: { strategy: "text", value: sourceStep.conditionalAction.actionTarget, exact: false },
                optional: true,

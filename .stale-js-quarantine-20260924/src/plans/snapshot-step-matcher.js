...
exports.findCandidateElementsForText = findCandidateElementsForText;
exports.findBestElementForStep = findBestElementForStep;
...
function findCandidateElementsForText(text, snapshot, preferredTypes) {
...
function findBestElementForStep(stepText, snapshot, preferredTypes) {

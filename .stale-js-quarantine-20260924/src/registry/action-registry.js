...
exports.getActionCapability = getActionCapability;
exports.listSupportedActions = listSupportedActions;
...
function getActionCapability(action) {
    return exports.actionRegistry.actions.find((entry) => entry.action === action);
}
function listSupportedActions() {
    return exports.actionRegistry.actions.map((entry) => entry.action);
}

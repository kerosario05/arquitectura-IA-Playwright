...
exports.validateObjectRegistry = validateObjectRegistry;
exports.assertValidObjectRegistry = assertValidObjectRegistry;
...
function issue(issues, level, code, message, objectKey) {
    issues.push({ level, code, message, objectKey });
}
function validateLocator(locator, objectKey, issues) {
...
function validateObject(item, issues) {
    ...
    if (!isObject(item.locator)) {
        ...
        validateLocator(item.locator, objectKey, issues);
    }
...
function validateObjectRegistry(registry) {
    const issues = [];
...
function assertValidObjectRegistry(registry) {

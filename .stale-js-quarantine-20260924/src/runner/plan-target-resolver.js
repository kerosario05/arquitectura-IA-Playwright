...
exports.resolveLocatorFromPlanTarget = resolveLocatorFromPlanTarget;
function requireTargetValue(target, context) {
...
function resolveLocatorFromPlanTarget(page, target) {
    ...
    throw new Error(`Unsupported target strategy: ${String(target.strategy)}`);
}

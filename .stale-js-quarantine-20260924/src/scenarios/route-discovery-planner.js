...
exports.planRouteDiscovery = planRouteDiscovery;
/**
 ...
 */
function planRouteDiscovery(request) {
    ...
    console.log(`[route-discovery-plan] requested appSlug=${appSlug} issue=${issueKey} huIntent=${huIntent} reason=${reasonCode}`);
    const result = {
        ok: true,
    ...
    console.log(`[route-discovery-plan] created discoveryType=intent_route_discovery recommendedMode=guided_route_discovery`);
    return result;
}

...
exports.buildAppProfilePromptContext = buildAppProfilePromptContext;
exports.formatAppProfileContext = formatAppProfileContext;
exports.buildEntryPathBlockFromContext = buildEntryPathBlockFromContext;
exports.logAppProfileContext = logAppProfileContext;
...
function buildAppProfilePromptContext(appSlug, options) {
...
function formatAppProfileContext(ctx) {
    if (!ctx.present)
        return "";
    const parts = [];
...
function buildEntryPathBlockFromContext(ctx) {
    if (ctx.entrySteps.length > 0) {
...
function logAppProfileContext(ctx) {
    const fields = [

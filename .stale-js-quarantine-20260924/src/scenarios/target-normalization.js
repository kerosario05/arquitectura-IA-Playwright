...
exports.targetsMatch = targetsMatch;
exports.findTargetInList = findTargetInList;
exports.detectMojibake = detectMojibake;
exports.buildNormalizedLookup = buildNormalizedLookup;
/**
 ...
 */
function findTargetInList(target, allowedTargets) {
 ...
 */
function detectMojibake(target) {
 ...
 */
function buildNormalizedLookup(targets) {

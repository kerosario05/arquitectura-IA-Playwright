...
exports.resolveReplayAdmission = resolveReplayAdmission;
/**
 ...
 */
function resolveReplayAdmission(input) {
    ...
    const requestedRejectedScenarios = input.evaluatedRejectedScenarios.filter((rejection) => requested.has(rejection.scenarioId) && evaluated.has(rejection.scenarioId));

...
exports.buildInputRequirementsContractSection = buildInputRequirementsContractSection;
exports.applyInputRequirementsToPreconditions = applyInputRequirementsToPreconditions;
...
function buildInputRequirementsContractSection(requirements) {
    return [
        SECTION_TITLE,
        SECTION_START,
...
function applyInputRequirementsToPreconditions(rawCase, requirements) {

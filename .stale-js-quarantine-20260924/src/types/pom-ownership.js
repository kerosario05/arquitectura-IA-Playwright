...
exports.CONTEXT_PRODUCING_INTENTS = exports.CONTEXT_DEPENDENT_INTENTS = exports.CLASS_SPECIFIC_METHODS = exports.INTENT_PREFERRED_OWNER = exports.INTENT_CLASS_OWNERSHIP = exports.METHOD_INTENT_PARAMS = exports.METHOD_INTENT_NAME_MAP = exports.SCREEN_TYPE_CLASS_MAP = void 0;
exports.getPreferredOwnerForIntent = getPreferredOwnerForIntent;
exports.isMethodAllowedForClass = isMethodAllowedForClass;
exports.getMisplacedMethodWarning = getMisplacedMethodWarning;
exports.isContextDependentIntent = isContextDependentIntent;
exports.getContextProducedByIntent = getContextProducedByIntent;
exports.SCREEN_TYPE_CLASS_MAP = {
    home: "HomePage",
...
exports.METHOD_INTENT_NAME_MAP = {
    open_home: "open",
...
exports.INTENT_CLASS_OWNERSHIP = {
...
exports.INTENT_PREFERRED_OWNER = {
...
exports.CLASS_SPECIFIC_METHODS = {
    ProductDetailPage: [
...
function getPreferredOwnerForIntent(intent) {
    return exports.INTENT_PREFERRED_OWNER[intent] ?? "GenericPage";
}
function isMethodAllowedForClass(className, intent) {
    const allowedClasses = exports.INTENT_CLASS_OWNERSHIP[intent];
    if (!allowedClasses)
        return true;
    return allowedClasses.includes(className);
}
function getMisplacedMethodWarning(className, methodName, intent) {
    const allowedClasses = exports.INTENT_CLASS_OWNERSHIP[intent];
    if (!allowedClasses)
        return null;
 ...
 */
exports.CONTEXT_DEPENDENT_INTENTS = new Set([
    "select_product",
    "select_category",
 ...
 */
exports.CONTEXT_PRODUCING_INTENTS = {
    open_home: "home",
    open_module: "module",
 ...
 */
function isContextDependentIntent(intent) {
    return exports.CONTEXT_DEPENDENT_INTENTS.has(intent);
}
/**
 * Get the context produced by an intent (if any)
 */
function getContextProducedByIntent(intent) {
    return exports.CONTEXT_PRODUCING_INTENTS[intent];
}

...
const SPEC_PLAN_PATH = 'automations/apps/default/cases/c30000-generic-reusable-automation/plan.json';
...
test('Generic reusable automation', async ({ page }) => {
  ...
  await executeExecutionPlan({
    ...
    evidenceDir: resolve(process.cwd(), 'automations/apps/default/cases/c30000-generic-reusable-automation/runs')
  });
});
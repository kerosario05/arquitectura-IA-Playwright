...
const SPEC_APP_PROFILE = 'app-b';
const SPEC_APP_CONFIG_PATH = 'automations/apps/app-b/app.config.json';
const SPEC_PLAN_PATH = 'automations/apps/app-b/plans/c37750-consulta-listado-de-tarjetas-de-credito.plan.json';
...
test('Consulta listado de tarjetas de credito', async ({ page }) => {
  ...
  await executeExecutionPlan({
    ...
    evidenceDir: resolve(process.cwd(), 'automations/apps/app-b/runs/c37750-consulta-listado-de-tarjetas-de-credito')
  });
});
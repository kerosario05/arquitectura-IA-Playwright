...
test('Validación de opciones disponibles tras iniciar el kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validación de opciones disponibles tras iniciar el kiosco';

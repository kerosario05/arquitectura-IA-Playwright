...
test('Validación de ausencia de información financiera en el flujo inicial', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validación de ausencia de información financiera en el flujo inicial';

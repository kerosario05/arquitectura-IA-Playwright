...
test('Visualizar campos principales del detalle del depósito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar campos principales del detalle del depósito a plazo';

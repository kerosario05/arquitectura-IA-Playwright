...
test('Validar formatos visibles del balance del deposito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar formatos visibles del balance del deposito a plazo';

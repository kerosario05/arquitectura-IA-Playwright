...
test('Visualizar formatos de monto, tasa y fecha en el detalle', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar formatos de monto, tasa y fecha en el detalle';

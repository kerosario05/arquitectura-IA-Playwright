...
test('Visualizar detalles de Tarjeta Crédito Visa Clásica', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C39286';
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Tarjeta Crédito Visa Clásica';

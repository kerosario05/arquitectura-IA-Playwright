...
test('Visualizar detalles de Cuenta de Ahorros Personal en Pesos', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C39287';
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Cuenta de Ahorros Personal en Pesos';
  ...
  const replayStep_5 = async () => { await productListPage.selectProduct('Cuentas'); };

...
test('Visualizar detalles de Préstamo Personal', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C39288';
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Préstamo Personal';

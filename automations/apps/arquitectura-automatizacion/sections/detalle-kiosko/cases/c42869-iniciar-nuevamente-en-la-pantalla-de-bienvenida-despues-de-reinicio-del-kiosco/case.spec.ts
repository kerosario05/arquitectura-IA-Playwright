...
test('Iniciar nuevamente en la pantalla de bienvenida despues de reinicio del kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42869';
  process.env.SCENARIO_TITLE = 'Iniciar nuevamente en la pantalla de bienvenida despues de reinicio del kiosco';

...
test('Validacion de opciones iniciales sin informacion financiera visible', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42927';
  process.env.SCENARIO_TITLE = 'Validacion de opciones iniciales sin informacion financiera visible';

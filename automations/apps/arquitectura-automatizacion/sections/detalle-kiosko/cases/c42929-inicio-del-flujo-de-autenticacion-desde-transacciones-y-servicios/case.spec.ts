...
test('Inicio del flujo de autenticacion desde Transacciones y servicios', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42929';
  process.env.SCENARIO_TITLE = 'Inicio del flujo de autenticacion desde Transacciones y servicios';

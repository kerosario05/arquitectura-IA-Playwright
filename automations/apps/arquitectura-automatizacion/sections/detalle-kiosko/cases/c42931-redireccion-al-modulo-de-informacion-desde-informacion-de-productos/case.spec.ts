...
test('Redireccion al modulo de informacion desde Informacion de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42931';
  process.env.SCENARIO_TITLE = 'Redireccion al modulo de informacion desde Informacion de productos';

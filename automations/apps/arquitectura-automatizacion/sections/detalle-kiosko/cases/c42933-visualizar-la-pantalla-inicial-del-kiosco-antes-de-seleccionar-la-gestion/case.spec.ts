...
test('Visualizar la pantalla inicial del kiosco antes de seleccionar la gestion', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42933';
  process.env.SCENARIO_TITLE = 'Visualizar la pantalla inicial del kiosco antes de seleccionar la gestion';

...
test('Validar las opciones principales disponibles en la pantalla de seleccion', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42934';
  process.env.SCENARIO_TITLE = 'Validar las opciones principales disponibles en la pantalla de seleccion';

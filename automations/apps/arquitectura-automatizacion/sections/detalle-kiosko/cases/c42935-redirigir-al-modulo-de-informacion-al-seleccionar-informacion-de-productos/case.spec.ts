...
test('Redirigir al modulo de informacion al seleccionar informacion de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42935';
  process.env.SCENARIO_TITLE = 'Redirigir al modulo de informacion al seleccionar informacion de productos';

...
test('Visualizar pantalla de seleccion de gestion luego de iniciar', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42937';
  process.env.SCENARIO_TITLE = 'Visualizar pantalla de seleccion de gestion luego de iniciar';

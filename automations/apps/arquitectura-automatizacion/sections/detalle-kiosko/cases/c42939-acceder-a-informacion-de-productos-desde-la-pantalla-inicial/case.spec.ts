...
test('Acceder a Informacion de productos desde la pantalla inicial', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42939';
  process.env.SCENARIO_TITLE = 'Acceder a Informacion de productos desde la pantalla inicial';

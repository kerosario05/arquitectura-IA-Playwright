...
test('Visualizar la pantalla inicial del kiosco antes de seleccionar la gestión', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42941';
  process.env.SCENARIO_TITLE = 'Visualizar la pantalla inicial del kiosco antes de seleccionar la gestión';

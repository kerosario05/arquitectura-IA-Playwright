...
test('Validar que las opciones iniciales se muestren sin información financiera', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42942';
  process.env.SCENARIO_TITLE = 'Validar que las opciones iniciales se muestren sin información financiera';

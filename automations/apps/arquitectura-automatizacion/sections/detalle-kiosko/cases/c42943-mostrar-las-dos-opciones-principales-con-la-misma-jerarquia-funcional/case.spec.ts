...
test('Mostrar las dos opciones principales con la misma jerarquía funcional', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42943';
  process.env.SCENARIO_TITLE = 'Mostrar las dos opciones principales con la misma jerarquía funcional';

...
test('Redirigir al módulo de información desde información de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42944';
  process.env.SCENARIO_TITLE = 'Redirigir al módulo de información desde información de productos';

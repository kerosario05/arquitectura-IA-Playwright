...
test('Visualizar pantalla de seleccion despues de iniciar el kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42956';
  process.env.SCENARIO_TITLE = 'Visualizar pantalla de seleccion despues de iniciar el kiosco';

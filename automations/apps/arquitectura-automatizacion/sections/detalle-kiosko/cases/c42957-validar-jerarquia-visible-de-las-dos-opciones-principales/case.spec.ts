...
test('Validar jerarquia visible de las dos opciones principales', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42957';
  process.env.SCENARIO_TITLE = 'Validar jerarquia visible de las dos opciones principales';

...
test('Redirigir al modulo de informacion desde Informacion de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42958';
  process.env.SCENARIO_TITLE = 'Redirigir al modulo de informacion desde Informacion de productos';

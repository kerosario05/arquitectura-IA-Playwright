...
test('Visualizar la pantalla inicial del kiosco y acceder a la seleccin de gestin', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42981';
  process.env.SCENARIO_TITLE = 'Visualizar la pantalla inicial del kiosco y acceder a la seleccin de gestin';

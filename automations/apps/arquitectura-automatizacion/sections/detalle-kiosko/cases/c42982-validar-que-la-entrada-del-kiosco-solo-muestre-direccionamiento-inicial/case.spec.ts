...
test('Validar que la entrada del kiosco solo muestre direccionamiento inicial', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42982';
  process.env.SCENARIO_TITLE = 'Validar que la entrada del kiosco solo muestre direccionamiento inicial';

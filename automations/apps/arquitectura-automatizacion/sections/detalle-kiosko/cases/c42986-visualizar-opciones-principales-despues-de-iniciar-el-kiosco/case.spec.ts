...
test('Visualizar opciones principales despues de iniciar el kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42986';
  process.env.SCENARIO_TITLE = 'Visualizar opciones principales despues de iniciar el kiosco';

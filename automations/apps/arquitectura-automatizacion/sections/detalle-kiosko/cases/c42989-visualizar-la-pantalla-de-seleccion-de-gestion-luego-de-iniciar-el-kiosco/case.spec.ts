...
test('Visualizar la pantalla de seleccion de gestion luego de iniciar el kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42989';
  process.env.SCENARIO_TITLE = 'Visualizar la pantalla de seleccion de gestion luego de iniciar el kiosco';

...
test('Validar visibilidad de las dos opciones principales en la pantalla de seleccion', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42990';
  process.env.SCENARIO_TITLE = 'Validar visibilidad de las dos opciones principales en la pantalla de seleccion';

...
test('Validar que el boton Iniciar sea visible en el punto de entrada del kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42993';
  process.env.SCENARIO_TITLE = 'Validar que el boton Iniciar sea visible en el punto de entrada del kiosco';

...
test('Visualizar la pantalla de selección de gestión después de iniciar', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42994';
  process.env.SCENARIO_TITLE = 'Visualizar la pantalla de selección de gestión después de iniciar';

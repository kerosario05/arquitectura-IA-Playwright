...
test('Validar ausencia de información financiera en las pantallas iniciales', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C42995';
  process.env.SCENARIO_TITLE = 'Validar ausencia de información financiera en las pantallas iniciales';

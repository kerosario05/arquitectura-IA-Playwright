...
test('Visualizar la pantalla inicial del kiosco antes de seleccionar una gestion', async ({ page }) => {
  ...
  process.env.SCENARIO_ID = 'C43008';
  process.env.SCENARIO_TITLE = 'Visualizar la pantalla inicial del kiosco antes de seleccionar una gestion';

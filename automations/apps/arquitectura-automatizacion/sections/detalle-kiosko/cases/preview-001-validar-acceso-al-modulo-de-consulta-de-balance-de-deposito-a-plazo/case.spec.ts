...
test('Validar acceso al modulo de consulta de balance de deposito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar acceso al modulo de consulta de balance de deposito a plazo';

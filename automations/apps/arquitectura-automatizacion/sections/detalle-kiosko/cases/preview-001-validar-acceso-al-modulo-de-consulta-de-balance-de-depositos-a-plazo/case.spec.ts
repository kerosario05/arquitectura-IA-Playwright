...
test('Validar acceso al módulo de consulta de balance de Depósitos a Plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar acceso al módulo de consulta de balance de Depósitos a Plazo';

...
test('Validar visualización de pantalla de bienvenida institucional', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar visualización de pantalla de bienvenida institucional';

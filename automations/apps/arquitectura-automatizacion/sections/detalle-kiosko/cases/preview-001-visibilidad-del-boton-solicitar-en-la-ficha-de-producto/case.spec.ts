...
test('Visibilidad del botón Solicitar en la ficha de producto', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visibilidad del botón Solicitar en la ficha de producto';

...
test('Visualizar categorías de productos desde el menú inicial', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar categorías de productos desde el menú inicial';

...
test('Visualizar categorías principales de Información de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar categorías principales de Información de productos';

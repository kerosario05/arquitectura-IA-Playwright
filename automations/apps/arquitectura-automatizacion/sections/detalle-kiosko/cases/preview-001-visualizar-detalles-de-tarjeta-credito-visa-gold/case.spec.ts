...
test('Visualizar detalles de Tarjeta Crédito Visa Gold', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Tarjeta Crédito Visa Gold';

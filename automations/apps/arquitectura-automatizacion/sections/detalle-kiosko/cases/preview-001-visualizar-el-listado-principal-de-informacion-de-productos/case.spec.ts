...
test('Visualizar el listado principal de Información de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar el listado principal de Información de productos';

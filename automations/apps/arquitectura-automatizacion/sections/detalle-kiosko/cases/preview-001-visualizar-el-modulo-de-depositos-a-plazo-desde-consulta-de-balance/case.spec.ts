...
test('Visualizar el módulo de Depósitos a Plazo desde consulta de balance', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar el módulo de Depósitos a Plazo desde consulta de balance';

...
test('Visualizar la pantalla inicial del kiosco y el acceso por Iniciar', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar la pantalla inicial del kiosco y el acceso por Iniciar';

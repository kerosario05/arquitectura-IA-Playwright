...
test('Visualizar listado de Préstamos desde Consulta de balance', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar listado de Préstamos desde Consulta de balance';

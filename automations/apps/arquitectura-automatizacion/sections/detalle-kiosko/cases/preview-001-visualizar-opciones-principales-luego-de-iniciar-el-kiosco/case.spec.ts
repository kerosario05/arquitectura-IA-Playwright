...
test('Visualizar opciones principales luego de iniciar el kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar opciones principales luego de iniciar el kiosco';

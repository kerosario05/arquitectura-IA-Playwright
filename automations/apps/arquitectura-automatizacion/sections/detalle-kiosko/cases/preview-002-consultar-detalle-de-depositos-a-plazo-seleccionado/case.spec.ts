...
test('Consultar detalle de Depósitos a Plazo seleccionado', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Consultar detalle de Depósitos a Plazo seleccionado';
  ...
  const replayStep_6 = async () => { await productListPage.selectProduct('Depósitos a Plazo'); };

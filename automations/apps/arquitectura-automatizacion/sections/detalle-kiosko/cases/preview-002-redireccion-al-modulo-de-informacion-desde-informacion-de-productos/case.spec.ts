...
test('Redireccion al modulo de informacion desde Información de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Redireccion al modulo de informacion desde Información de productos';

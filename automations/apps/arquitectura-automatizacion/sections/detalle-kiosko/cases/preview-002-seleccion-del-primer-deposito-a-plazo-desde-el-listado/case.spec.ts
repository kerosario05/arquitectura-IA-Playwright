...
test('Seleccion del primer deposito a plazo desde el listado', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Seleccion del primer deposito a plazo desde el listado';

...
test('Seleccionar el primer depósito a plazo visible del listado', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Seleccionar el primer depósito a plazo visible del listado';

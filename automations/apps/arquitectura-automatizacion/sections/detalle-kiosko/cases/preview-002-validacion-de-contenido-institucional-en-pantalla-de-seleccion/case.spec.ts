...
test('Validacion de contenido institucional en pantalla de seleccion', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validacion de contenido institucional en pantalla de seleccion';

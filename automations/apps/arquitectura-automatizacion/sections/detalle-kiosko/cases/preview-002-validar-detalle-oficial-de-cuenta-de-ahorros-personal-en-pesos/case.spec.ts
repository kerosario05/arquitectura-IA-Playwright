...
test('Validar detalle oficial de Cuenta de Ahorros Personal en Pesos', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar detalle oficial de Cuenta de Ahorros Personal en Pesos';

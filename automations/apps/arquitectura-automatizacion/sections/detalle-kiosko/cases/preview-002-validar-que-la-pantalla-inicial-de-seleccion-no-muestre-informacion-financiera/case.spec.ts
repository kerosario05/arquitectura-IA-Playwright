...
test('Validar que la pantalla inicial de seleccion no muestre informacion financiera', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar que la pantalla inicial de seleccion no muestre informacion financiera';

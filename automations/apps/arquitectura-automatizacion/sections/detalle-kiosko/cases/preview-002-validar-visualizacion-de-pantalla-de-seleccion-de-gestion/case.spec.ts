...
test('Validar visualización de pantalla de selección de gestión', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar visualización de pantalla de selección de gestión';

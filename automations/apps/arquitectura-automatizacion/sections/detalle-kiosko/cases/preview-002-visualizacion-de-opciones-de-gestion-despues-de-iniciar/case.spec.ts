...
test('Visualizacion de opciones de gestion despues de iniciar', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizacion de opciones de gestion despues de iniciar';

...
test('Visualización de opciones disponibles en la segunda pantalla', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualización de opciones disponibles en la segunda pantalla';

...
test('Visualizar detalles de Tarjeta de Crédito Visa Infinite', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Tarjeta de Crédito Visa Infinite';

...
test('Visualizar monto y plazo en el detalle del deposito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar monto y plazo en el detalle del deposito a plazo';

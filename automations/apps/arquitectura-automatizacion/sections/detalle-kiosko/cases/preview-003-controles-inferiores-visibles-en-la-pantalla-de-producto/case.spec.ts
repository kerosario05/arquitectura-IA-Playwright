...
test('Controles inferiores visibles en la pantalla de producto', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Controles inferiores visibles en la pantalla de producto';

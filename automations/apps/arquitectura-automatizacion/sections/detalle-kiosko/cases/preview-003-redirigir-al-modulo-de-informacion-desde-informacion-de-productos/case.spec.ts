...
test('Redirigir al modulo de informacion desde Información de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Redirigir al modulo de informacion desde Información de productos';

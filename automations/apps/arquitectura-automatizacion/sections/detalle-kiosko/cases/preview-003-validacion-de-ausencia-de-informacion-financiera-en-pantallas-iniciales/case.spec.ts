...
test('Validacion de ausencia de informacion financiera en pantallas iniciales', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validacion de ausencia de informacion financiera en pantallas iniciales';

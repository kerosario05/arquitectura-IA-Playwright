...
test('Validar campos principales del detalle de depósito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar campos principales del detalle de depósito a plazo';

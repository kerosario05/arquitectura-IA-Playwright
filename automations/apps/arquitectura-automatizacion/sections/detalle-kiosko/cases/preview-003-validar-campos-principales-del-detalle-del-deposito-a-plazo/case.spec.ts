...
test('Validar campos principales del detalle del deposito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar campos principales del detalle del deposito a plazo';

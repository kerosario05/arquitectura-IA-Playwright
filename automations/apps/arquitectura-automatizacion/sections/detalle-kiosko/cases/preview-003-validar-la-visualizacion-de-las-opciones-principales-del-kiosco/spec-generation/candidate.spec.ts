...
test('Validar la visualizacion de las opciones principales del kiosco', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar la visualizacion de las opciones principales del kiosco';

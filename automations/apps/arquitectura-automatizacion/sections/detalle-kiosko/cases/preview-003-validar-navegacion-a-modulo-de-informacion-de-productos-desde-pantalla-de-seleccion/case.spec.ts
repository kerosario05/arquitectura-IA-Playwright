...
test('Validar navegación a módulo de Información de productos desde pantalla de selección', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar navegación a módulo de Información de productos desde pantalla de selección';

...
test('Visualizacion de campos principales del detalle del deposito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizacion de campos principales del detalle del deposito a plazo';

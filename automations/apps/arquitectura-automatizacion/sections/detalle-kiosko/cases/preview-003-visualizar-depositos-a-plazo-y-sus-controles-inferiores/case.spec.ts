...
test('Visualizar Depósitos a Plazo y sus controles inferiores', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar Depósitos a Plazo y sus controles inferiores';

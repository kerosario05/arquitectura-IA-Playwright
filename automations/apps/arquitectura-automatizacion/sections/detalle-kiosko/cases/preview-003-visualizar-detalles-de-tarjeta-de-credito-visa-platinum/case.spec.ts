...
test('Visualizar detalles de Tarjeta de Crédito Visa Platinum', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Tarjeta de Crédito Visa Platinum';

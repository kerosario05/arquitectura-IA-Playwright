...
test('Visualizar el destino informativo despues de seleccionar Información de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar el destino informativo despues de seleccionar Información de productos';

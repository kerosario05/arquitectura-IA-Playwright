...
test('Visualizar tasa de interes en la consulta del deposito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar tasa de interes en la consulta del deposito a plazo';

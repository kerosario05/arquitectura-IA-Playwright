...
test('Consultar el detalle del primer producto visible de Tarjetas', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Consultar el detalle del primer producto visible de Tarjetas';

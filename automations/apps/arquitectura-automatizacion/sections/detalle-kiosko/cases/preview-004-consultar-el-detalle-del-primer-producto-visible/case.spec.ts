...
test('Consultar el detalle del primer producto visible', async ({ page }) => {
  ...
  await promotedRuntime.expectPromotedVisible({ stepIndex: 7, target: 'Solicitar', assertion: async () => { await productDetailPage.clickPrimaryAction('Solicitar'); } });
});
...
test('Iniciar autenticacion antes de consultas personalizadas desde transacciones y servicios', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Iniciar autenticacion antes de consultas personalizadas desde transacciones y servicios';

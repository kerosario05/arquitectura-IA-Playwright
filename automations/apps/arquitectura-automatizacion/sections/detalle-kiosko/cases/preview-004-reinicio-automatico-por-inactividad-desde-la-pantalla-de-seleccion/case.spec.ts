...
test('Reinicio automático por inactividad desde la pantalla de selección', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Reinicio automático por inactividad desde la pantalla de selección';

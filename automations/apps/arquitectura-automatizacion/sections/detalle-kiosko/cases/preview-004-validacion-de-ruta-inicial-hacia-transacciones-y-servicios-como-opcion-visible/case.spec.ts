...
test('Validacion de ruta inicial hacia transacciones y servicios como opcion visible', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validacion de ruta inicial hacia transacciones y servicios como opcion visible';

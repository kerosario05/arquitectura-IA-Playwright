...
test('Validar formato de datos del detalle del depósito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar formato de datos del detalle del depósito a plazo';

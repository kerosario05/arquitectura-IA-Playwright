...
test('Validar inicio de flujo de autenticación al seleccionar transacciones y servicios', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar inicio de flujo de autenticación al seleccionar transacciones y servicios';

...
test('Visualizar detalle del primer préstamo visible', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar detalle del primer préstamo visible';

...
test('Visualizar detalle oficial del primer producto visible', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar detalle oficial del primer producto visible';

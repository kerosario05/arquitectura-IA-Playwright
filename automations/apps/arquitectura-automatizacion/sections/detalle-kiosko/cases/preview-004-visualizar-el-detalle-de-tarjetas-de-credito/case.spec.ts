...
test('Visualizar el detalle de Tarjetas de crédito', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar el detalle de Tarjetas de crédito';
  ...
  const replayStep_5 = async () => { await productListPage.selectProduct('Tarjetas'); };

...
test('Consultar el detalle del primer producto visible de Depósitos a Plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Consultar el detalle del primer producto visible de Depósitos a Plazo';

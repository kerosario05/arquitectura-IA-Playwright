...
test('Validacion de ausencia de informacion financiera en la capa inicial', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validacion de ausencia de informacion financiera en la capa inicial';

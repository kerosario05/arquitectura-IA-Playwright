...
test('Validar la frontera de autenticacion antes de consultas personalizadas', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar la frontera de autenticacion antes de consultas personalizadas';

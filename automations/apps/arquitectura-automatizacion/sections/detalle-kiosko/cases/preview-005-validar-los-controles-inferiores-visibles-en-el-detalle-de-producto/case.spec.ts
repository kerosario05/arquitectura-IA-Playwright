...
test('Validar los controles inferiores visibles en el detalle de producto', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar los controles inferiores visibles en el detalle de producto';

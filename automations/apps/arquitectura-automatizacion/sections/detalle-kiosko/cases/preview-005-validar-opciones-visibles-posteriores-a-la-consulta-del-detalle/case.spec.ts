...
test('Validar opciones visibles posteriores a la consulta del detalle', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar opciones visibles posteriores a la consulta del detalle';

...
test('Validar opciones visibles posteriores al detalle del deposito a plazo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar opciones visibles posteriores al detalle del deposito a plazo';

...
test('Visualizar controles inferiores del detalle del producto', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar controles inferiores del detalle del producto';

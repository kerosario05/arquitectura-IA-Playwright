...
test('Visualizar controles inferiores en detalle de producto', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar controles inferiores en detalle de producto';

...
test('Visualizar importes monetarios del préstamo consultado', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar importes monetarios del préstamo consultado';

...
test('Consultar el detalle del primer producto visible de Cuentas de Efectivo', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Consultar el detalle del primer producto visible de Cuentas de Efectivo';

...
test('Regresar desde el detalle al listado de productos', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Regresar desde el detalle al listado de productos';

...
test('Validar los controles inferiores visibles desde el detalle del producto', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Validar los controles inferiores visibles desde el detalle del producto';

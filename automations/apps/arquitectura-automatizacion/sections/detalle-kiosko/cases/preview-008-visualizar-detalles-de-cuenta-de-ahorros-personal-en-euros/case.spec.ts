...
test('Visualizar detalles de Cuenta de Ahorros Personal en Euros', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Cuenta de Ahorros Personal en Euros';

...
test('Visualizar detalles de Depósitos a Plazo en Dólares', async ({ page }) => {
  ...
  process.env.SCENARIO_TITLE = 'Visualizar detalles de Depósitos a Plazo en Dólares';

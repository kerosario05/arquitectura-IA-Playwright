...
test('Finalizar sesión desde detalle de producto', async ({ page }) => {
  ...
  const replayStep_7 = async () => { await productListPage.selectFirstVisibleCard('el primer préstamo visible del listado'); };
  ...
  await promotedRuntime.clickPromotedTarget({ stepIndex: 8, target: 'Finalizar sesión', actionIntent: 'click_primary_action', expectedEffect: 'ui_change', sensitive: false, previousStepReplays: [{ stepIndex: 3, actionIntent: 'start_session', target: 'Iniciar', sensitive: false, replay: replayStep_3 }, { stepIndex: 4, actionIntent: 'open_product_information', target: 'Información de productos', sensitive: false, replay: replayStep_4 }, { stepIndex: 5, actionIntent: 'select_category', target: 'Préstamos', sensitive: false, replay: replayStep_5 }, { stepIndex: 6, actionIntent: 'select_category', target: 'Préstamos personales', sensitive: false, replay: replayStep_6 }, { stepIndex: 7, actionIntent: 'select_visible_item_by_ordinal', target: 'el primer préstamo visible del listado', sensitive: false, replay: replayStep_7 }], lastSelectionStep: { stepIndex: 7, selectedTarget: 'el primer préstamo visible del listado' }, lastSelectionReplay: async () => {

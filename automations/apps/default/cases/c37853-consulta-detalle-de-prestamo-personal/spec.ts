...
const SPEC_PLAN_PATH = 'automations/apps/default/cases/c37853-consulta-detalle-de-prestamo-personal/plan.json';
...
test('Consulta detalle de prestamo personal', async ({ page }) => {
  ...
  await executeExecutionPlan({
    ...
    evidenceDir: resolve(process.cwd(), 'automations/apps/default/cases/c37853-consulta-detalle-de-prestamo-personal/runs')
  });
});
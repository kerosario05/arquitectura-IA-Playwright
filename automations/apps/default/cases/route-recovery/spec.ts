...
const SPEC_PLAN_PATH = 'automations/apps/default/cases/route-recovery/plan.json';
...
test('Route recovery', async ({ page }) => {
  ...
  await executeExecutionPlan({
    ...
    evidenceDir: resolve(process.cwd(), 'automations/apps/default/cases/route-recovery/runs')
  });
});
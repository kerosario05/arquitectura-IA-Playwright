...
test('Visualizar detalle de Tarjetas de crédito', async ({ page }) => {
  ...
  await promotedRuntime.expectPromotedVisible({ stepIndex: 7, target: 'Volver', assertion: async () => { await productDetailPage.expectLoaded(); } }); // [target: Volver]
});
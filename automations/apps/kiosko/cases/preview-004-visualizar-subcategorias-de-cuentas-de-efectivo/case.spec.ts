...
test('Visualizar subcategorías de Cuentas de Efectivo', async ({ page }) => {
  ...
  await promotedRuntime.expectPromotedVisible({ stepIndex: 6, target: 'Volver', assertion: async () => { await productDetailPage.expectLoaded(); } }); // [target: Volver]
});
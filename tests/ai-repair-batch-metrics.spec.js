...
function createCaseSummary(overrides) {
    return {
        enabled: false,
        invocations: 0,
        providerName: null,
...
(0, test_1.test)("batch without AI Repair - zero invocations", () => {
    const caseSummaries = [
    ...
    (0, test_1.expect)(batch.casesWithAiRepair).toBe(0);
    (0, test_1.expect)(batch.totalInvocations).toBe(0);
    (0, test_1.expect)(batch.appliedRepairs).toBe(0);
    (0, test_1.expect)(batch.blockedRepairs).toBe(0);
    (0, test_1.expect)(batch.providerErrors).toBe(0);
    (0, test_1.expect)(batch.byProvider).toEqual({});
    (0, test_1.expect)(batch.cases).toHaveLength(0);
});
(0, test_1.test)("batch with one case that applied repaired_plan", () => {
    const caseSummaries = [
        {
            caseId: "C001",
            appSlug: "app-1",
    ...
    const batch = (0, ai_repair_summary_builder_1.buildAiRepairBatchSummary)(caseSummaries);
    (0, test_1.expect)(batch.casesWithAiRepair).toBe(1);
    (0, test_1.expect)(batch.totalInvocations).toBe(1);
    (0, test_1.expect)(batch.appliedRepairs).toBe(1);
    (0, test_1.expect)(batch.byProvider.gemini).toBeDefined();
    (0, test_1.expect)(batch.byProvider.gemini.invocations).toBe(1);
    (0, test_1.expect)(batch.byProvider.gemini.appliedRepairs).toBe(1);
});
(0, test_1.test)("batch with multiple cases and providers", () => {
    const caseSummaries = [
        {
            caseId: "C001",
            appSlug: "app-1",
    ...
    (0, test_1.expect)(batch.byProvider.gemini).toBeDefined();
    (0, test_1.expect)(batch.byProvider.openai).toBeDefined();
    (0, test_1.expect)(batch.byProvider.gemini.invocations).toBe(2);
    (0, test_1.expect)(batch.byProvider.openai.invocations).toBe(1);
});
(0, test_1.test)("batch with provider_error", () => {
    const caseSummaries = [
        {
            caseId: "C001",
            appSlug: "app-1",
    ...
    const batch = (0, ai_repair_summary_builder_1.buildAiRepairBatchSummary)(caseSummaries);
    (0, test_1.expect)(batch.providerErrors).toBe(1);
    (0, test_1.expect)(batch.byProvider.gemini.providerErrors).toBe(1);
});
(0, test_1.test)("batch with case without aiRepairSummary - does not break aggregation", () => {
    ...
    (0, test_1.expect)(batch.casesWithAiRepair).toBe(1);
    (0, test_1.expect)(batch.totalInvocations).toBe(1);
    (0, test_1.expect)(batch.cases).toHaveLength(1);
    (0, test_1.expect)(batch.cases[0].caseId).toBe("C001");
});
(0, test_1.test)("console output prints batch summary", () => {
    const batch = {
        casesWithAiRepair: 2,
        totalInvocations: 4,
        appliedRepairs: 2,
    ...
    (0, test_1.expect)(output).toContain("[ai-repair:batch-summary]");
...
(0, test_1.test)("console output does not print secrets", () => {
    ...
    (0, test_1.expect)(output).not.toContain("secret");
    (0, test_1.expect)(output).not.toContain("api_key");
    (0, test_1.expect)(output).toContain("[ai-repair:batch-summary]");
});
...
(0, test_1.test)("batch summary with invalid_response", () => {
    const caseSummaries = [
        {
            caseId: "C001",
            appSlug: "app-1",
...
(0, test_1.test)("batch summary with blocked sensitive action", () => {
    const caseSummaries = [
        {
            caseId: "C001",
            appSlug: "app-1",

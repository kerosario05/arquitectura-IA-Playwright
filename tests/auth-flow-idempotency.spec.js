...
test_1.test.describe('AuthFlow State Awareness and Idempotency', () => {
    (0, test_1.test)('AuthFlow ensureAuthenticated is idempotent when called from authenticated state', () => {
        ...
        (0, test_1.expect)(expectedBehavior.success).toBe(true);
        (0, test_1.expect)(expectedBehavior.clicksPerformed).toBe(0);
    });
    (0, test_1.test)('AuthFlow ensureAuthenticated handles identification stage correctly', () => {
        ...
        (0, test_1.expect)(expectedBehavior.skippedActions).toContain('click Iniciar');
        (0, test_1.expect)(expectedBehavior.performedActions).toContain('completeIdentification');
    });
    (0, test_1.test)('AuthFlow ensureAuthenticated handles phone_confirmation stage correctly', () => {
        ...
        (0, test_1.expect)(expectedBehavior.skippedActions).toContain('completeIdentification');
        (0, test_1.expect)(expectedBehavior.performedActions).toContain('completePhoneConfirmation');
    });
    (0, test_1.test)('AuthFlow ensureAuthenticated handles otp stage correctly', () => {
        ...
        (0, test_1.expect)(expectedBehavior.skippedActions).toContain('completeIdentification');
        (0, test_1.expect)(expectedBehavior.performedActions).toContain('completeOtp');
    });
    (0, test_1.test)('AuthFlow does not use fixed waitForTimeout as primary transition mechanism', () => {
        // AuthFlow should use:
        ...
        (0, test_1.expect)(expectedWaits.primary).toContain('waitForLoadState');
        (0, test_1.expect)(expectedWaits.primary).toContain('waitForSelector');
    });
    (0, test_1.test)('AuthFlow logs state transitions for debugging', () => {
        // AuthFlow should log:
        ...
        (0, test_1.expect)(expectedLogs).toContain('[auth-flow] currentStage=...');
        (0, test_1.expect)(expectedLogs).toContain('[auth-flow] action=...');
    });
    (0, test_1.test)('AuthFlow provides structured error when stuck', () => {
        ...
        (0, test_1.expect)(expectedErrorStructure).toHaveProperty('currentStage');
        (0, test_1.expect)(expectedErrorStructure).toHaveProperty('currentUrl');
    });
    (0, test_1.test)('Promoted spec sequence: start -> open protected entry -> AuthFlow -> open module', () => {
        ...
        (0, test_1.expect)(expectedSpecSequence[2].action).toContain('authFlow.ensureAuthenticated()');
        (0, test_1.expect)(expectedSpecSequence[2].result).toContain('detects identification stage');
    });
});

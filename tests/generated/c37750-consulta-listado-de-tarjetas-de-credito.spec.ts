...
const planPath = resolve(
  process.cwd(),
  'automations/plans/c37750-consulta-listado-de-tarjetas-de-credito.plan.json'
);
...
test('Consulta listado de tarjetas de credito', async ({ page }) => {
  ...
  await executeExecutionPlan({
    ...
    evidenceDir: './.artifacts/executions/generated/c37750-consulta-listado-de-tarjetas-de-credito'
  });
});

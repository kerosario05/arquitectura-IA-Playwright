...
test_1.test.describe("Scenario Preview Integration - Catalog Enrichment", () => {
    (0, test_1.test)("full flow: generateScenarioPreview with catalog enrichment (no execution)", async () => {
        ...
        (0, test_1.expect)(true).toBe(true); // Placeholder - full mock implementation needed
    });
    (0, test_1.test)("catalog enrichment doesn't expand HU scope", async () => {
    ...
    (0, test_1.test)("catalogMode=existing reuses cache without discovery", async () => {
    ...
    (0, test_1.test)("catalogMode=existing triggers discovery for stale catalog", async () => {
    ...
    (0, test_1.test)("catalogMode=refresh forces re-discovery", async () => {
    ...
    (0, test_1.test)("coverageMode=exhaustive adds seeds for uncovered products", async () => {
    ...
    (0, test_1.test)("coverageMode=representative does not add seeds", async () => {
    ...
    (0, test_1.test)("discovery failure falls back gracefully", async () => {
    ...
    (0, test_1.test)("no specs written during Generate scenarios phase", async () => {

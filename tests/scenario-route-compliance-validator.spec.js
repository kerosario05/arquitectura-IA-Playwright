...
test_1.test.describe("Scenario Route Compliance Validator - Multi-App", () => {
    (0, test_1.test)("canonical functional action remains valid without execution allowlist backing", () => {
        const context = {
            appSlug: "app",
        ...
        const result = (0, scenario_route_compliance_validator_1.validateScenarioCompliance)(scenario, context, undefined, [claim]);
        (0, test_1.expect)(result.valid).toBe(true);
        (0, test_1.expect)(result.reasonCode).toBe("valid");
        (0, test_1.expect)(result.diagnostics.some((diagnostic) => diagnostic.level === "warning")).toBe(true);
    });
    (0, test_1.test)("unbacked click is rejected", () => {
        const context = {
            appSlug: "retail-app",
        ...
        const result = (0, scenario_route_compliance_validator_1.validateScenarioCompliance)(scenario, context);
        (0, test_1.expect)(result.valid).toBe(false);
        (0, test_1.expect)(result.reasonCode).toBe("unbacked_click_target");
        (0, test_1.expect)(result.diagnostics.some(d => d.level === "error" && d.target === "Contenido X")).toBe(true);
    });
    (0, test_1.test)("assertion-only term used as click is rejected", () => {
        const context = {
            appSlug: "banking-app",
        ...
        const result = (0, scenario_route_compliance_validator_1.validateScenarioCompliance)(scenario, context);
        (0, test_1.expect)(result.valid).toBe(false);
        (0, test_1.expect)(result.reasonCode).toBe("assertion_term_used_as_click");
        (0, test_1.expect)(result.diagnostics.some(d => d.level === "error" && d.message.includes("assertion-only term"))).toBe(true);
    });
    (0, test_1.test)("validation of assertion-only term is allowed", () => {
        const context = {
    ...
    (0, test_1.test)("sensitive action click is rejected", () => {
        const context = {
            appSlug: "banking-app",
        ...
        const result = (0, scenario_route_compliance_validator_1.validateScenarioCompliance)(scenario, context);
        (0, test_1.expect)(result.valid).toBe(false);
        (0, test_1.expect)(result.reasonCode).toBe("sensitive_click_not_allowed");
    });
    (0, test_1.test)("sensitive action validation is allowed", () => {
        const context = {
            appSlug: "banking-app",
    ...
    (0, test_1.test)("alias backed by profile is allowed", () => {
    ...
    (0, test_1.test)("valid scenario with existing route passes", () => {
        const context = {
            appSlug: "retail-app",
    ...
    (0, test_1.test)("validateScenariosCompliance filters invalid scenarios", () => {
        const context = {
            appSlug: "app-b",
        ...
        const result = (0, scenario_route_compliance_validator_1.validateScenariosCompliance)(scenarios, context, new Map());
        (0, test_1.expect)(result.validScenarios.length).toBe(1);
        (0, test_1.expect)(result.invalidScenarios.length).toBe(1);
        (0, test_1.expect)(result.validScenarios[0].sourceIssueKey).toBe("TEST-8");
        (0, test_1.expect)(result.invalidScenarios[0].scenario.sourceIssueKey).toBe("TEST-9");
        (0, test_1.expect)(result.invalidScenarios[0].result.reasonCode).toBe("unbacked_click_target");
    });
    (0, test_1.test)("entry step target is allowed via additionalEntryTargets", () => {
        const context = {
            appSlug: "app-a",
    ...
    (0, test_1.test)("mojibake target matches via normalization", () => {
        const context = {
        ...
        (0, test_1.expect)(result.diagnostics.some(d => d.level === "info" && d.message.includes("normalized_mojibake"))).toBe(true);
    });
    (0, test_1.test)("accent-insensitive matching works", () => {
        const context = {
            appSlug: "banking-app",
        ...
        (0, test_1.expect)(result.reasonCode).toBe("valid");
        // Check that normalization strategy was logged
        (0, test_1.expect)(result.diagnostics.some(d => d.level === "info" && d.message.includes("normalized_accent"))).toBe(true);
    });
    (0, test_1.test)("unbacked click still rejected after normalization", () => {
        const context = {
            appSlug: "retail-app",
            allowedExecutableClicks: ["Iniciar", "Información de productos"],
            assertionOnlyTerms: [],
        ...
        (0, test_1.expect)(result.valid).toBe(false);
        (0, test_1.expect)(result.reasonCode).toBe("unbacked_click_target");
        (0, test_1.expect)(result.diagnostics.some(d => d.level === "error" && d.target === "Contenido informativo")).toBe(true);
    });
});
